...
2. Click ![](res/2.1-4.png)  button to find and select the workspace. Then click OK.


### 2.1.2	Switch WorkSpace

*  Click ![](res/2.1-5.png)  button in 
