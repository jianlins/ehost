...
| File | Contains |
|---|---|
| `eHOST.sys` | eHOST's own settings — annotator name, workspace path, which toolbar features are visible, whether the RESTful server is enabled, whether the legacy *Sync Assignments* button is shown |
