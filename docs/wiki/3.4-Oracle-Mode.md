...
1. Click 
   ...
   ![](https://github.com/chrisleng/ehost/blob/master/res/3.4-1.PNG) 

   at the bottom right to make sure the Oracle mode is on. (on for Blue, off for gray)

   ![](https://github.com/chrisleng/ehost/blob/master/res/3.4-2.PNG)
...
3. Oracle mode window will pop out.
   ...
   ![](https://github.com/chrisleng/ehost/blob/master/res/3.4-3.PNG)
