...
public class HighlightExample {
  public static void main(String[] args) {
    ...
    try {
      textPane.read(new FileReader("pom.xml"), null);
    } catch (Exception e) {
...
//          baseline + 1);
      g.fillRoundRect(alloc.x,alloc. y, alloc.width, 13, 7, 7);
  ...
  protected static final HighlightPainter sharedPainter = new UnderlineHighlightPainter(
      null);
