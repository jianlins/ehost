...
/**
 * This class is to build a static memory for all running parameters, which
 * can be used to record and track the running status of eHOST. 
 *
 * @author Jianwei Chris Leng
 */
public class Parameters {

        /**标记：关于Navigation Panel和Oracle Function，说明我们工作在一个单个文件，
         * 还是整个banrch.
         */
        ...
        /**This is a flag that used to indicate whether user wants to
         * quickly popup the attribute editor window after 2 clicked on an
         * annotation.
         */
        ...
        public static class corpus{
             ...
             *
             * @param   textfile
             *          The text source file which you want to add into memory.
             */
            ...
            /**
         * To a given text file, check whether it is a text file, whose suffix name is
         * ".txt" or ".TXT" or ".Txt".
         *
         * @param   file
         *          The file you want to check its suffix name is text file suffix name.
         */
         ...
         * @param   _amountOfWordsInFile  type:int
         *          the amount of all words in this file.
         */
         ...
         * @param   _index      type: int<p>
         *          index of list of selected clinicel
         *                              notes.
         * @return  String      the filename which is on the specific
         *          position of list of selected clinical notes.
         */
        ...
        /**Get the absolute filename in a specific position of list of
         * selected clinical notes.
         * @param   _index      type: int<p>
         *          index of list of selected clinicel
         * @return  String      absolute filename in a specific position of
         * list of selected clinical notes.
         */
        ...
        /**
         * Flag used to control whether show graphics path between annotations
         * for complex relationships on document viewer.
         */
        ...
        // init
        static{ PREANNOTATED_CONCEPT_DICTIONARIES = new ArrayList(); }
        static{ VERIFIER_DICTIONARIES = new ArrayList<dictionaries.VerifierDictionaryFormat>();}
        static{ AttributeSchemas = new AttributeList();}
        //static{ ComplexRelationshipNames = new TreeSet<ComplexRel>();}
        static{ RelationshipSchemas = new RelSchemaList();}
         ...
         * @param   int _newLatestUsedMentionID<p>
         *          latest used mention id.
         */
        ...
        /**Set of parameters for smart oracle module which can help you find
         * similar annotation in document
         */
        ...
        public static class AnnotationsImportingCorrelated{
             ...
             * "allImportedXMLs" is that the return-value of this fuction can
             * make sure there is no repetitive in its return.
             */
        ...
        public static class WorkSpace{
            ...
            /**Absolutely path of current workspace:
             * Details: while record this in configure file, blank space need to
             * be replaced by symbol '='; and it should be changed back while
             * reload path of latest used workspace.
             */
        ...
        public static class NLPAssistant{
            /**<tt>OUTPUTCUSTOMREGEX</tt>: boolean, use to enable/disable
             * filter of custom regular expression */
            public static boolean OUTPUTCUSTOMREGEX = false;

            public static boolean Output_Dates = false;
            /**<tt> OUTPUTNEGATION</tt>: boolean, enable/disable searching
             * and output of negation phrase */
        ...
        /**Parameters related displaying annotation uniques in the tree on
         * the navigation panel
         */
        public static class ShowAnnotationUniquesInTree{
            /**There are 2 sequences style to display annotation uniques in the
             * tree view on the navigation panel. One is by the sequence of
             * characters, the other one is by their location in the documents.
             *
         ...
         * annotations will be searched based on the checkboxes selected by
         * user on class "ghostandduplicatesSeeker.java" in package of "ResultEditor.Annotations.Opt"
         */
        public static class DuplicatesAndGhostSeeker{
            ...
            /**flag that for us to search ghost annotations whose span is out of current document*/
        ...
        /**Parameters that used during building relationships between selected 
         * two annotations via editor, the original annotation can be selected 
         * on the editor panel or the comparator panel.*/
        public static class CreateRelationship{
            
            /**A Flag that tell us whether user want to create relationship, and 
             * annotation on which panel(editor or comparator panel) will be used
             * to create these relationship. 
             * To build a relationship, we need to select two annotations: first 
             * one is the start and the second will be linked to that one. It 
             * can be selected from the comparator panel.
             * 
