...
public class Parameters {
    ...
    public static class corpus {
         ...
         *
         * @param textfile The text source file which you want to add into memory.
         */
         ...
         * ".txt" or ".TXT" or ".Txt".
         *
         * @param file The file you want to check its suffix name is text file suffix name.
         */
     ...
     *
     * @param _newLatestUsedMentionID _newLatestUsedMentionID<p>
    ...
    public static String previousProjectPath=null;
