...
public class integratedDictionary extends javax.swing.JPanel implements GUIInterface
{
    ...
    private void initComponents() {
        ...
        added.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        conflicts.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        classFiltered.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        annotatorFiltered.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        bothFiltered.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        totalClasses.setCursor(new Cursor(Cursor.HAND_CURSOR));
