...
public class RegexEditor extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        jPanel_topbar.setBorder(javax.swing.BorderFactory.createMatteBorder(5, 5, 0, 5, new Color(255, 254, 253)));
        jPanel_topbar.setLayout(new java.awt.BorderLayout());

        jPanel_holder_description.setBackground(new Color(255, 253, 252));
        ...
        jPanel_holder_fromto.setBackground(new Color(240, 241, 242));
        jPanel_holder_fromto.setPreferredSize(new Dimension(0, 20));
        jPanel_holder_fromto.setLayout(new java.awt.GridLayout(1, 2, 4, 0));

        jPanel14.setBackground(new Color(0, 51, 102));
        jPanel14.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 51, 102), 3));
        jPanel14.setForeground(new Color(0, 102, 153));
        ...
        jPanel_holder_fromto1.setBackground(new Color(240, 241, 242));
        jPanel_holder_fromto1.setPreferredSize(new Dimension(0, 20));
        jPanel_holder_fromto1.setLayout(new java.awt.GridLayout(1, 2, 4, 0));

        jPanel15.setBackground(new Color(0, 51, 102));
        jPanel15.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(102, 153, 255)));
        jPanel15.setForeground(new Color(0, 102, 153));
        jPanel15.setLayout(new java.awt.BorderLayout());

        name.setFont(new java.awt.Font("Calibri", 0, 13)); // NOI18N
        name.setForeground(new Color(0, 51, 204));
        name.setBorder(null);
        ...
        jPanel_holder_fromto2.setBackground(new Color(240, 241, 242));
        jPanel_holder_fromto2.setPreferredSize(new Dimension(0, 20));
        jPanel_holder_fromto2.setLayout(new java.awt.GridLayout(1, 2, 4, 0));

        jPanel16.setBackground(new Color(0, 51, 102));
        jPanel16.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 51, 102), 3));
        jPanel16.setForeground(new Color(0, 102, 153));
        ...
        jPanel19.setBackground(new Color(0, 51, 102));
        jPanel19.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 51, 102), 3));
        jPanel19.setForeground(new Color(0, 102, 153));
        ...
        jPanel13.setBackground(new Color(255, 254, 253));
        jPanel13.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 5, 0, 5, new Color(255, 254, 253)));
        jPanel13.setLayout(new java.awt.BorderLayout());

        jPanel_holder_fromto3.setBackground(new Color(240, 241, 242));
        jPanel_holder_fromto3.setPreferredSize(new Dimension(0, 20));
        jPanel_holder_fromto3.setLayout(new java.awt.GridLayout(1, 2, 4, 0));

        jPanel17.setBackground(new Color(0, 51, 102));
        jPanel17.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 1, 1, new Color(0, 51, 102)));
        jPanel17.setForeground(new Color(0, 102, 153));
        jPanel17.setLayout(new java.awt.BorderLayout());

        jScrollPane1.setBorder(null);

        jList_from.setBackground(new Color(204, 204, 204));
        ...
        jPanel18.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 1, 1, new Color(0, 51, 102)));
        jPanel18.setForeground(new Color(0, 102, 153));
        jPanel18.setLayout(new java.awt.BorderLayout());

        jScrollPane2.setBorder(null);

        jList_to.setBackground(new Color(204, 204, 204));
    ...
    private JList jList_from;
    private JList jList_to;
