...
public class RelationshipSchemaEditor extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        jList_of_relationshipSchemas = new JList();
        ...
        list_of_attributeNames = new JList();
        ...
        list_of_attributeValues = new JList();
        ...
        jPanel14.setMinimumSize(new Dimension(85, 16));
    ...
    private void addAttValue(){
        ...
        currentAtt.getAllAllowedEntries().add(text);
    ...
    private JList jList_of_relationshipSchemas;
    ...
    private JList list_of_attributeNames;
    private JList list_of_attributeValues;
