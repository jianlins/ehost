...
public class SelectAnnotators extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createMatteBorder(20, 10, 5, 10, new Color(255, 255, 254)));
        ...
        jPanel2.setBackground(new Color(255, 255, 254));
        ...
        jPanel_center.setBackground(new Color(238, 238, 237));
        jPanel_center.setLayout(new java.awt.GridLayout(2, 2, 3, 0));

        jPanel_selectClasses.setBackground(new Color(255, 255, 254));
        jPanel_selectClasses.setLayout(new java.awt.GridLayout(1, 2, 4, 0));

        jPanel9.setBackground(new Color(255, 254, 255));
        jPanel9.setLayout(new java.awt.BorderLayout());

        jScrollPane_annotator.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 51, 51)));
        ...
        jLabel_warning.setForeground(new Color(153, 0, 0));
        ...
        jCheckBox_check_attributes.setBackground(new Color(255, 255, 255));
        ...
        jCheckBox_check_relationships.setBackground(new Color(255, 255, 255));
        ...
        jRadioButton_check_same_spans.setBackground(new Color(255, 255, 255));
        ...
        jCheckBox_check_comments.setBackground(new Color(255, 255, 255));
        ...
        jPanel3.setBackground(new Color(255, 255, 254));
        jPanel3.setLayout(new java.awt.GridLayout(1, 3, 2, 0));

        jPanel4.setBackground(new Color(255, 255, 254));
        jPanel4.setLayout(new java.awt.BorderLayout());

        jScrollPane_annotator1.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 51, 51)));
        ...
        jLabel_warning1.setForeground(new Color(153, 0, 0));
        jLabel_warning1.setText("Select Classes:");
        jPanel4.add(jLabel_warning1, java.awt.BorderLayout.PAGE_START);

        jPanel3.add(jPanel4);

        jPanel7.setBackground(new Color(255, 255, 254));
        jPanel7.setLayout(new java.awt.BorderLayout());

        jScrollPane_annotator2.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 51, 51)));
        ...
        jLabel_warning3.setForeground(new Color(153, 0, 0));
        jLabel_warning3.setText("Select Attributes:");
        jPanel7.add(jLabel_warning3, java.awt.BorderLayout.PAGE_START);

        jPanel3.add(jPanel7);

        jPanel8.setBackground(new Color(255, 255, 254));
        jPanel8.setLayout(new java.awt.BorderLayout());

        jScrollPane_annotator3.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 51, 51)));
        ...
        jLabel_warning4.setForeground(new Color(153, 0, 0));
