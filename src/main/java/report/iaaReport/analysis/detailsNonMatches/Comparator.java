...
public class Comparator {
    ...
    public static boolean equalRelationships(Annotation annotation1,
            Annotation annotation2, String filename, boolean relax_compare) throws Exception {
        if ((annotation1 == null) || (annotation2 == null))
        ...
        // items are NOT equal
        if (annotation1.relationships.size() != annotation2.relationships.size())
            return false;
        ...
        for (AnnotationRelationship cr1 : annotation1.relationships) {
            ...
            for (AnnotationRelationship cr2 : annotation2.relationships) {
                ...
                if (compare2ComplexRelationship(cr1, cr2, filename, relax_compare)) {
                    foundMatchedNR = true;
                    break;
                }
    ...
    public static boolean equalAttributes(Annotation annotation1,
        ...
        // consider they are NOT same if the numbers of their normal relationship
        // items are NOT equal
        if (annotation1.attributes.size() != annotation2.attributes.size()) {
            // System.out.println("miss matching length of vectors:" +
            // annotation1.normalrelationships.size() + ", " +
            // annotation2.normalrelationships.size());
            return false;
        }
    ...
    private static boolean compare2ComplexRelationship(
            ...
            String filename, boolean relax_compare)
            throws Exception
    {
            ...
            for(AnnotationRelationshipDef value1: cr1.linkedAnnotations)
            {
                ...
                for(AnnotationRelationshipDef value2: cr2.linkedAnnotations)
                {
                    ...
                    if(value1.linkedAnnotationIndex == value2.linkedAnnotationIndex )
                    {
                        ...
                        if (relax_compare){
                            if( a1.spanset.isOverlapping( a2.spanset ) 
