...
public class OracleFunction extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel_top.setBackground(new Color(254, 255, 255));
        jPanel_top.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(254, 255, 255), 5));
        jPanel_top.setLayout(new java.awt.BorderLayout());

        jPanel2.setBackground(new Color(245, 245, 244));
        ...
        jPanel6.setBackground(new Color(254, 255, 255));
        jPanel6.setPreferredSize(new Dimension(35, 68));
        ...
        jPanel_top_center.setBackground(new Color(254, 255, 255));
        jPanel_top_center.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(254, 255, 255), 5));
        ...
        jPanel_top_right.setBackground(new Color(254, 255, 255));
        ...
        jPanel_center.setBackground(new Color(254, 255, 255));
        jPanel_center.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(254, 255, 255), 5));
        jPanel_center.setLayout(new java.awt.BorderLayout());

        jPanel_content_left1.setLayout(new java.awt.BorderLayout());

        jPanel8.setBackground(new Color(254, 255, 255));
        jPanel8.setPreferredSize(new Dimension(35, 406));
        ...
        jSplitPane1.setBackground(new Color(255, 255, 254));
        jSplitPane1.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 102, 102), 2));
        jSplitPane1.setDividerLocation(420);
        jSplitPane1.setResizeWeight(0.8);

        jPanel1.setBackground(new Color(254, 255, 255));
        ...
        jPanel9.setBackground(new Color(255, 255, 254));
        ...
        jScrollPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(153, 153, 153)));
        ...
        jPanel_bottom.setBackground(new Color(240, 240, 241));
        jPanel_bottom.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(240, 240, 241), 3));
    ...
    private void listMouseClicked(MouseEvent evt) {//GEN-FIRST:event_listMouseClicked
    ...
    private void listMouseMoved(MouseEvent evt) {//GEN-FIRST:event_listMouseMoved
    ...
    private void showAnnotationUnderMouse(MouseEvent evt, JList thislist){
        try{
            if (evt==null)
                return;
