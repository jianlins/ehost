...
public class GhostAndDuplicatesSeeker extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new Color(208, 204, 204));
        jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(208, 204, 204), 3));
        jPanel2.setLayout(new java.awt.BorderLayout());

        jPanel4.setBackground(new Color(208, 204, 204));
        jPanel4.setLayout(new java.awt.GridLayout(1, 2, 2, 0));

        jButton2.setBackground(new Color(208, 204, 204));
        ...
        jCheckBox_checkDuplicates_forSameSpans.setBackground(new Color(255, 255, 255));
        ...
        jCheckBox_checkDuplicates_forSameAttributes.setBackground(new Color(255, 255, 255));
        ...
        jCheckBox_checkDuplicates_forSameRelationships.setBackground(new Color(255, 255, 255));
        ...
        jCheckBox_ghost_annotation_spanless.setBackground(new Color(255, 255, 255));
        ...
        jCheckBox_ghost_classless.setBackground(new Color(255, 255, 255));
        jCheckBox_ghost_classless.setFont(new java.awt.Font("Cambria", 0, 12));
        jCheckBox_ghost_classless.setText("classless spans");

        jCheckBox_ghost_outofrange.setBackground(new Color(255, 255, 255));
        ...
        jButton_currentdoc.setForeground(new Color(102, 0, 0));
        ...
        jButton_alldocs.setForeground(new Color(102, 0, 0));
        ...
        jPanel_results.setBackground(new Color(240, 240, 242));
        jPanel_results.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 0, 204)));
        jPanel_results.setLayout(new java.awt.BorderLayout());

        jSplitPane1.setBackground(new Color(238, 238, 237));
        jSplitPane1.setBorder(null);
        jSplitPane1.setDividerLocation(400);

        jPanel7.setBackground(new Color(238, 238, 237));
        jPanel7.setLayout(new java.awt.BorderLayout());

        jTabbedPane1.setBackground(new Color(238, 238, 237));
        ...
        jButton_currentdoc1.setForeground(new Color(102, 0, 0));
        ...
        jButton_currentdoc2.setForeground(new Color(102, 0, 0));
        ...
        jCheckBox_checkDuplicates_forSameClass.setBackground(new Color(255, 255, 255));
