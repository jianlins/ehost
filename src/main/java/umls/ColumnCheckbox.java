    ...
    private boolean removeCUI(String cui){
        ...
        if ((this.annotation != null) && (annotation.annotationclass != null)) {
            ...
            try {// record class names
                AnnotationClass thisclass = classdepot.getAnnotatedClass(annotation.annotationclass);
                ...
                for ( int j=atts.size()-1; j>=0;j-- ) {
                    ...
                    if (att.isCode && ( att.getAllAllowedEntries()!= null )) {
     ...
     /**add this cui and its label as a option into attributes whose "isCode" is true.*/
