...
public class GUI extends JFrame {
    ...
    /**
     * This is the jPanel contains components and functions of the NLP
     * assistatnt, it's the gui that show the process of NLP
     */
    ...
    public void init(String workspacePath) {
        ...
        try {
            if (workspacePath != null) {
                ...
                if (path.exists()) {
                    Parameters.WorkSpace.WorkSpace_AbsolutelyPath = workspacePath;
                    Parameters.WorkSpace.CurrentProject = path;
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        STANDARD_TEXTFIELD_BOARD = (new JTextField()).getBorder();// jTextField_sample.getBorder();
     ...
     *
     * @param _on_or_off true: display the panel of document viewer by setting it to
     *                   visible; false: hide the panel of document viewer
     */
    ...
    private void initComponents() {
        ...
        buttonGroup_Tabs = new ButtonGroup();
        jTextField_sample = new JTextField();
        buttonGroup_treeview = new ButtonGroup();
        jLabel_icon_annotationlist = new JLabel();
        buttonGroup_quicknlp = new ButtonGroup();
        jDialog_Confirm_before_Removing_Annotations = new JDialog();
        jPanel10 = new JPanel();
        jLabel10 = new JLabel();
        jLabel7 = new JLabel();
        jLabel15 = new JLabel();
        ...
        buttonGroup_listAnnotationsInSequences = new ButtonGroup();
        jSplitPane_Annotations_Comparator = new JSplitPane();
        buttonGroup1 = new ButtonGroup();
        ToolBar = new JToolBar();
        jToggleButton_ResultEditor = new JToggleButton();
        jToggleButton_CreateAnnotaion = new JToggleButton();
        jToggleButton_PinExtractor = new JToggleButton();
        jToggleButton_DictionaryManager = new JToggleButton();
        jToggleButton_Converter = new JToggleButton();
        jToggleButton_DictionarySetting = new JToggleButton();
        jToggle_AssignmentsScreen = new JToggleButton();
        jToggleButton_exit = new JToggleButton();
        BottomInfoBar = new JPanel();
        jPanel_leftSeparator = new JPanel();
        jPanel_infobar_right_current_annotator = new JPanel();
        jLabel_info_annotator = new JLabel();
        jPanel2 = new JPanel();
        jLabel_info_annotatorlabel = new JLabel();
        jSeparator1 = new JSeparator();
        jPanel_infobar_center = new JPanel();
        jLabel_infobar = new JLabel();
        jPanel58 = new JPanel();
        jPanel1 = new JPanel();
        jLabel22 = new JLabel();
        jSeparator6 = new JSeparator();
        jLabel_infobar_FlagOfOracle = new JLabel();
        jLabel_infobar_FlagOfDiff = new JLabel();
        jLabel_infobar_attributeEditor = new JLabel();
        jPanel3 = new JPanel();
        jRadioButton_annotationMode = new JRadioButton();
        jRadioButton_adjudicationMode = new JRadioButton();
        GUIContainer = new JPanel();
        Editor = new JPanel();
        NavigationPanel1 = new navigatorContainer.TabPanel(this, 0);
        jPanel_NAV_CardContainer = new JPanel();
        jPanel_NAV_Card1 = new JPanel();
        jPanel8_topBar = new JPanel();
        jLabel31 = new JLabel();
        jPanel8_bottomBar = new JPanel();
        jButton_AddClinicalTexts1 = new JButton();
        jButton26 = new JButton();
        jPanel88 = new JPanel();
        jPanel8_currentWorkSpace = new JPanel();
        jLabel18 = new JLabel();
        jPanel95 = new JPanel();
        jLabel9 = new JLabel();
        jComboBox_currentworkspace_abspath = new JComboBox();
        jPanel17 = new JPanel();
        jButton5 = new JButton();
        jPanel47 = new JPanel();
        jScrollPane11 = new JScrollPane();
        jList_NAV_projects = new JList();
        jPanel91 = new JPanel();
        jSeparator3 = new JSeparator();
        jLabel20 = new JLabel();
        jPanel_NAV_Card2 = new JPanel();
        jPanel8_topBar1 = new JPanel();
        jLabel32 = new JLabel();
        jPanel8_bottomBar1 = new JPanel();
        jButton_AddClinicalTexts = new JButton();
        jButton2 = new JButton();
        jPanel_corpuslist_outline = new JPanel();
        jPanel_corpuslist_innerline = new JPanel();
        jPanel99 = new JPanel();
        jLabel21 = new JLabel();
        jScrollPane12 = new JScrollPane();
        jList_corpus = new JList();
        jPanel_NAV_Card3 = new JPanel();
        jPanel_colorfulTextBar_filebrowser6 = new JPanel();
        jLabel28 = new JLabel();
        ...
        jToggleButton_sequence_inLocation = new JToggleButton();
        jToggleButton_sequence_inCharacters = new JToggleButton();
        jPanel57 = new JPanel();
        jRadioButton_treeview_currentarticle = new JRadioButton();
        jRadioButton_treeview_overall = new JRadioButton();
        jScrollPane_classtree = new JScrollPane();
        jTree_class = new JTree();
        jCardcontainer_interactive = new JPanel();
        jPanel_NLP = new JPanel();
        jSplitPane_between_viewer_and_allatttibutes = new JSplitPane();
        jPanel_interactive_left = new JPanel();
        jPanel73 = new JPanel();
        NavigationPanel_editor = new resultEditor.customComponents.ExpandablePanel_editor(
                jSplitPane_between_viewer_and_allatttibutes, GUIContainer);
        jPanel12 = new JPanel();
        jPanel37 = new JPanel();
        jPanel_colorfulTextBar_filebrowser2 = new JPanel();
        jLabel25 = new JLabel();
        jPanel8 = new JPanel();
        jToolBar3 = new JToolBar();
        jComboBox_InputFileList = new JComboBox();
        jLabel3 = new JLabel();
        jButton13 = new JButton();
        jButton14 = new JButton();
        jSeparator4 = new JToolBar.Separator();
        jButton_importAnnotations = new JButton();
        jButton_removeduplicates = new JButton();
        jButton_save = new JButton();
        jButton20 = new JButton();
        jButton21 = new JButton();
        jButton22 = new JButton();
        jButton_removeAllAnnotations = new JButton();
        jButton_save1 = new JButton();
        jButton_importAnnotations1 = new JButton();
        jPanel24 = new JPanel();
        ...
        jPanel36 = new JPanel();
        jPanel43 = new JPanel();
        jLabel_cursor = new JLabel();
        jPanel38 = new JPanel();
        jTextField_searchtext = new JTextField();
        jButton1 = new JButton();
        jPanel46 = new JPanel();
        jScrollPane_textpane = new JScrollPane();
        textPaneforClinicalNotes = new userInterface.txtScreen.TextScreen();
        jPanel_position_indicator_container = new JPanel();
        jPanel77 = new JPanel();
        jPanel78 = new JPanel();
        jPanel79 = new JPanel();
        jPanel80 = new JPanel();
        ...
        jLabel26 = new JLabel();
        classes = new JLabel();
        annotations = new JLabel();
        annotators = new JLabel();
        overlapping = new JLabel();
        workingConflicts = new JLabel();
        jPanel86 = new JPanel();
        jPanel92 = new JPanel();
        verifierFlagged = new JLabel();
        jPanel90 = new JPanel();
        verifierOnCurrent = new JButton();
        verifierOnAll = new JButton();
        jPanel81 = new JPanel();
        jLabel1 = new JLabel();
        jLabel29 = new JLabel();
        ...
        infoList = new JList();
        jPanel83 = new JPanel();
        displayCurrent = new JButton();
        refresh = new JButton();
        jPanel_reportFormContainer = new JPanel();
        jPanel_MainFrame_Right = new JPanel();
        jPanel_EditorPanel = new JPanel();
        jPanel9 = new JPanel();
        jPanel5 = new JPanel();
        jPanel40 = new JPanel();
        jPanel_colorfulTextBar_filebrowser3 = new JPanel();
        jLabel27 = new JLabel();
        jPanel94 = new JPanel();
        jToolBar_editopanel_comparison = new JToolBar();
        ...
        jButton_spaneditor_delete = new JButton();
        jSeparator2 = new JToolBar.Separator();
        jButton_spaneditor_lefttToLeft = new JButton();
        jButton_spaneditor_leftToRight = new JButton();
        jButton_span_rightToLeft = new JButton();
        jButton4_spanEditor_rightToRight = new JButton();
        jPanel59 = new JPanel();
        jPanel60 = new userInterface.annotationCompare.ExpandButton(jPanel_MainFrame_Right,
                this.jSplitPane_between_viewer_and_allatttibutes, jPanel_comparator_container,
                jPanel_EditorPanel);
        jPanel41 = new JPanel();
        jPanel_multipleResultShowList = new JPanel();
        jScrollPane5 = new JScrollPane();
        jList_selectedAnnotations = new JList();
        jPanel45 = new JPanel();
        jLabel12 = new JLabel();
        jPanel50 = new JPanel();
        jPanel74 = new JPanel();
        jPanel4 = new JPanel();
        jPanel7 = new JPanel();
        jPanel_annotation_details = new JPanel();
        jLabel19 = new JLabel();
        jPanel20 = new JPanel();
        jPanel21 = new JPanel();
        jPanel23 = new JPanel();
        jButton_SpanAdd = new JButton();
        jButton_SpanRemove = new JButton();
        jScrollPane_Spans = new JScrollPane();
        jList_Spans = new JList();
        jPanel19 = new JPanel();
        jPanel64 = new JPanel();
        jPanel65 = new JPanel();
        jPanel55 = new JPanel();
        ...
        jLabel16 = new JLabel();
        jPanel44 = new JPanel();
        jTextField_annotationClassnames = new JTextField();
        jButton_SelectClass = new JButton();
        jLabel38 = new JLabel();
        jPanel66 = new JPanel();
        ...
        jLabel39 = new JLabel();
        jPanel18 = new JPanel();
        jButton_cr = new JToggleButton();
        delete_Relationships = new JButton();
        jButton_relationships = new JButton();
        jScrollPane8 = new JScrollPane();
        jList_complexrelationships = new JList();
        jPanel71 = new JPanel();
        jPanel63 = new JPanel();
        jButton_attribute = new JButton();
        jLabel40 = new JLabel();
        jScrollPane9 = new JScrollPane();
        jList_normalrelationship = new JList();
        jPanel75 = new JPanel();
        jPanel76 = new JPanel();
        jLabel37 = new JLabel();
        jLabel33 = new JLabel();
        jTextField_creationdate = new JTextField();
        jTextField_annotator = new JTextField();
        jPanel87 = new JPanel();
        jPanel84 = new JPanel();
        jPanel68 = new JPanel();
        ...
        jTextPane_explanations = new JTextPane();
        jPanel_colorfulTextBar_filebrowser4 = new JPanel();
        jPanel69 = new JPanel();
        jButton12 = new JButton();
        jPanel72 = new JPanel();
        jLabel41 = new JLabel();
        jPanel_colorfulTextBar_filebrowser7 = new JPanel();
        jLabel42 = new JLabel();
        jPanel_comparator_container = new JPanel();
        jPanel_textPane = new JPanel();
        JPanel_PinsExtractor = new JPanel();
        jPanel_Converter = new JPanel();
        ...
        jLabel6.setFont(new Font("Calibri", 0, 18)); // NOI18N
        ...
        confirmExit.getContentPane().add(jPanel13, BorderLayout.NORTH);

        jPanel16.setBorder(BorderFactory.createLineBorder(new Color(238, 238,
                238), 3));
        jPanel16.setLayout(new BorderLayout());

        jButton7.setFont(new Font("Calibri", 1, 15)); // NOI18N
        ...
        jButton6.setFont(new Font("Calibri", 1, 15)); // NOI18N
        jButton6.setText("No");
        ...
        org.jdesktop.layout.GroupLayout jPanel22Layout = new org.jdesktop.layout.GroupLayout(
                jPanel22);
        ...
        jPanel22Layout.setHorizontalGroup(jPanel22Layout.createParallelGroup(
                ...
                jPanel22Layout
                        ...
                        .addContainerGap()
                        .add(jButton7, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 78,
                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jButton6, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 87,
        ...
        jPanel22Layout.setVerticalGroup(jPanel22Layout.createParallelGroup(
                ...
                jPanel22Layout
                        ...
                        .add(jPanel22Layout
                                ...
                                .add(jButton7).add(jButton6))
                        .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE,
                                Short.MAX_VALUE)));

        jPanel16.add(jPanel22, BorderLayout.EAST);
        ...
        jLabel15.setFont(new Font("Georgia", 0, 12)); // NOI18N
        ...
        jPanel10Layout.setHorizontalGroup(jPanel10Layout.createParallelGroup(
                ...
                jPanel10Layout
                        ...
                        .add(jPanel10Layout
                                .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                .add(jLabel7).add(jLabel15)).addContainerGap(17, Short.MAX_VALUE)));
        jPanel10Layout
                .setVerticalGroup(jPanel10Layout
                        ...
                        .add(jPanel10Layout
                                ...
                                .add(jPanel10Layout
                                        ...
                                        .add(jPanel10Layout.createSequentialGroup().add(30, 30, 30)
                                                .add(jLabel10))
                                        .add(jPanel10Layout
                                                .createSequentialGroup()
                                                .add(38, 38, 38)
                                                ...
                                                .addPreferredGap(
                                                        ...
                                                        Short.MAX_VALUE).add(jLabel15)))
                                .addContainerGap(40, Short.MAX_VALUE)));

        jDialog_Confirm_before_Removing_Annotations.getContentPane().add(jPanel10,
                BorderLayout.CENTER);

        jPanel11.setBackground(new Color(242, 240, 240));
        jPanel11.setBorder(BorderFactory.createLineBorder(new Color(242, 240,
                240), 4));

        jButton8.setFont(new Font("Georgia", 0, 12)); // NOI18N
        ...
        jButton11.setFont(new Font("Georgia", 0, 12)); // NOI18N
        ...
        jDialog_Confirm_before_Removing_Annotations.getContentPane().add(jPanel11,
                BorderLayout.SOUTH);

        jSplitPane_Annotations_Comparator.setBackground(new Color(220, 220, 220));
        jSplitPane_Annotations_Comparator.setBorder(BorderFactory
                .createLineBorder(new Color(222, 222, 222)));
...
//        }
        ...
        jToggleButton_ResultEditor.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jToggleButton_CreateAnnotaion.setMaximumSize(new Dimension(106, 100));
        jToggleButton_CreateAnnotaion.setMinimumSize(new Dimension(106, 0));
        jToggleButton_CreateAnnotaion.setPreferredSize(new Dimension(106, 43));
        jToggleButton_CreateAnnotaion.setVerticalTextPosition(SwingConstants.BOTTOM);
        jToggleButton_CreateAnnotaion.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jToggleButton_PinExtractor.setMaximumSize(new Dimension(90, 100));
        jToggleButton_PinExtractor.setMinimumSize(new Dimension(90, 0));
        jToggleButton_PinExtractor.setVerticalTextPosition(SwingConstants.BOTTOM);
        jToggleButton_PinExtractor.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jToggleButton_DictionaryManager.setMaximumSize(new Dimension(100, 100));
        jToggleButton_DictionaryManager.setMinimumSize(new Dimension(100, 0));
        jToggleButton_DictionaryManager.setVerticalTextPosition(SwingConstants.BOTTOM);
        jToggleButton_DictionaryManager.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jToggleButton_Converter.setMaximumSize(new Dimension(110, 43));
        jToggleButton_Converter.setMinimumSize(new Dimension(110, 0));
        jToggleButton_Converter.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jToggleButton_DictionarySetting.setMinimumSize(new Dimension(110, 0));
        jToggleButton_DictionarySetting.setVerticalTextPosition(SwingConstants.BOTTOM);
        jToggleButton_DictionarySetting.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jToggle_AssignmentsScreen.setMaximumSize(new Dimension(130, 100));
        jToggle_AssignmentsScreen.setMinimumSize(new Dimension(100, 28));
        jToggle_AssignmentsScreen.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        BottomInfoBar.setBackground(new Color(199, 183, 190));
        BottomInfoBar.setBorder(BorderFactory.createLineBorder(new Color(183,
                183, 183), 3));
        BottomInfoBar.setMinimumSize(new Dimension(289, 34));
        BottomInfoBar.setPreferredSize(new Dimension(500, 24));
        BottomInfoBar.setRequestFocusEnabled(false);
        BottomInfoBar.setVerifyInputWhenFocusTarget(false);
        BottomInfoBar.setLayout(new BorderLayout());

        jPanel_leftSeparator.setBackground(new Color(183, 183, 183));
        jPanel_leftSeparator.setMinimumSize(new Dimension(4, 0));
        jPanel_leftSeparator.setPreferredSize(new Dimension(2, 22));

        org.jdesktop.layout.GroupLayout jPanel_leftSeparatorLayout = new org.jdesktop.layout.GroupLayout(
                jPanel_leftSeparator);
        jPanel_leftSeparator.setLayout(jPanel_leftSeparatorLayout);
        jPanel_leftSeparatorLayout.setHorizontalGroup(jPanel_leftSeparatorLayout
                .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 4,
                        Short.MAX_VALUE));
        jPanel_leftSeparatorLayout.setVerticalGroup(jPanel_leftSeparatorLayout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(0, 18, Short.MAX_VALUE));

        BottomInfoBar.add(jPanel_leftSeparator, BorderLayout.WEST);

        jPanel_infobar_right_current_annotator.setBackground(new Color(183, 183, 183));
        jPanel_infobar_right_current_annotator.setForeground(new Color(204, 204, 204));
        jPanel_infobar_right_current_annotator.setLayout(new BorderLayout());

        jLabel_info_annotator.setFont(new Font("Courier New", 1, 12)); // NOI18N
        jLabel_info_annotator.setText("jLabel18");
        jLabel_info_annotator.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                jLabel_info_annotatorMouseClicked(evt);
            }
        });
        jPanel_infobar_right_current_annotator.add(jLabel_info_annotator,
                BorderLayout.CENTER);

        jPanel2.setBackground(new Color(183, 183, 183));
        ...
        jPanel2.add(jLabel_info_annotatorlabel, BorderLayout.CENTER);

        jSeparator1.setOrientation(SwingConstants.VERTICAL);
        jPanel2.add(jSeparator1, BorderLayout.WEST);

        jPanel_infobar_right_current_annotator.add(jPanel2, BorderLayout.WEST);

        BottomInfoBar.add(jPanel_infobar_right_current_annotator, BorderLayout.EAST);

        jPanel_infobar_center.setBackground(new Color(183, 183, 183));
        jPanel_infobar_center.setMinimumSize(new Dimension(200, 24));
        ...
        jPanel58.add(jPanel1, BorderLayout.EAST);

        jPanel3.setBackground(new Color(183, 183, 183));
        jPanel3.setLayout(new GridLayout(1, 0));

        jRadioButton_annotationMode.setBackground(new Color(183, 183, 183));
        buttonGroup1.add(jRadioButton_annotationMode);
        jRadioButton_annotationMode.setFont(new Font("Verdana", 0, 12)); // NOI18N
        jRadioButton_annotationMode.setSelected(true);
        jRadioButton_annotationMode.setText("Annotation Mode");
        jRadioButton_annotationMode.addMouseListener(new MouseAdapter() {
            public void mouseReleased(MouseEvent evt) {
        ...
        jRadioButton_adjudicationMode.setBackground(new Color(183, 183, 183));
        buttonGroup1.add(jRadioButton_adjudicationMode);
        jRadioButton_adjudicationMode.setFont(new Font("Verdana", 0, 12)); // NOI18N
        jRadioButton_adjudicationMode.setText("Adjudication Mode");
        jRadioButton_adjudicationMode.addMouseListener(new MouseAdapter() {
            public void mouseReleased(MouseEvent evt) {
        ...
        jPanel58.add(jPanel3, BorderLayout.CENTER);

        jPanel_infobar_center.add(jPanel58, BorderLayout.EAST);

        BottomInfoBar.add(jPanel_infobar_center, BorderLayout.CENTER);

        getContentPane().add(BottomInfoBar, BorderLayout.SOUTH);

        GUIContainer.setBackground(new Color(237, 237, 237));
        GUIContainer.setForeground(new Color(204, 204, 204));
        GUIContainer.setPreferredSize(new Dimension(890, 440));
        GUIContainer.setRequestFocusEnabled(false);
        GUIContainer.setVerifyInputWhenFocusTarget(false);
        GUIContainer.setLayout(new CardLayout());

        Editor.setBackground(new Color(102, 102, 102));
        Editor.setLayout(new BorderLayout());

        NavigationPanel1.setPreferredSize(new Dimension(200, 485));
        NavigationPanel1.setLayout(new BorderLayout());

        jPanel_NAV_CardContainer.setBackground(new Color(238, 238, 239));
        jPanel_NAV_CardContainer.setBorder(BorderFactory.createMatteBorder(0, 2, 0, 0,
                new Color(153, 153, 153)));
        jPanel_NAV_CardContainer.setLayout(new CardLayout());

        jPanel_NAV_Card1.setBorder(BorderFactory.createMatteBorder(1, 2, 1, 1,
                new Color(0, 0, 51)));
        jPanel_NAV_Card1.setLayout(new BorderLayout());

        jPanel8_topBar.setBackground(new Color(0, 51, 102));
        jPanel8_topBar.setLayout(new BorderLayout());

        jLabel31.setBackground(new Color(41, 119, 167));
        jLabel31.setFont(new Font("Calibri", 1, 13)); // NOI18N
        jLabel31.setForeground(new Color(204, 204, 204));
        jLabel31.setText("WORKSPACE & PROJECT");
        jLabel31.setMaximumSize(new Dimension(5000, 19));
        jLabel31.setMinimumSize(new Dimension(1, 1));
        jLabel31.setPreferredSize(new Dimension(200, 19));
        jLabel31.setRequestFocusEnabled(false);
        jLabel31.setVerifyInputWhenFocusTarget(false);
        jPanel8_topBar.add(jLabel31, BorderLayout.CENTER);

        jPanel_NAV_Card1.add(jPanel8_topBar, BorderLayout.NORTH);

        jPanel8_bottomBar.setBackground(new Color(237, 237, 237));
        ...
        jButton_AddClinicalTexts1.setHorizontalTextPosition(SwingConstants.RIGHT);
        jButton_AddClinicalTexts1.setMaximumSize(new Dimension(100, 27));
        jButton_AddClinicalTexts1.setMinimumSize(new Dimension(100, 27));
        jButton_AddClinicalTexts1.setPreferredSize(new Dimension(100, 27));
        jButton_AddClinicalTexts1.setVerticalAlignment(SwingConstants.BOTTOM);
        jButton_AddClinicalTexts1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton26.setPreferredSize(new Dimension(77, 30));
        ...
        jPanel_NAV_Card1.add(jPanel8_bottomBar, BorderLayout.SOUTH);

        jPanel88.setLayout(new BorderLayout());

        jPanel8_currentWorkSpace.setBackground(new Color(237, 237, 237));
        jPanel8_currentWorkSpace.setMaximumSize(new Dimension(297, 87));
        ...
        jPanel95.setLayout(new GridLayout(3, 0));

        jLabel9.setFont(new Font("Calibri", 1, 12)); // NOI18N
        jLabel9.setText(" My WorkSpace:");
        jPanel95.add(jLabel9);

        jComboBox_currentworkspace_abspath.setModel(new DefaultComboBoxModel(
                new String[]{"Item 1", "Item 2", "Item 3", "Item 4"}));
        jComboBox_currentworkspace_abspath.setMinimumSize(null);
        jComboBox_currentworkspace_abspath.setPreferredSize(null);
        jComboBox_currentworkspace_abspath.addItemListener(new ItemListener() {
        ...
        jPanel17Layout.setHorizontalGroup(jPanel17Layout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(
                jPanel17Layout.createSequentialGroup().add(jButton5)
        ...
        jPanel8_currentWorkSpace.add(jPanel95, BorderLayout.CENTER);

        jPanel88.add(jPanel8_currentWorkSpace, BorderLayout.NORTH);

        jPanel47.setBackground(new Color(238, 238, 237));
        jPanel47.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1,
                new Color(238, 238, 237)));
        ...
        jList_NAV_projects.setModel(new AbstractListModel() {
        ...
        jList_NAV_projects.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        jPanel47.add(jScrollPane11, BorderLayout.CENTER);

        jPanel91.setBackground(new Color(238, 238, 239));
        jPanel91.setLayout(new BorderLayout());
        jPanel91.add(jSeparator3, BorderLayout.NORTH);

        jLabel20.setFont(new Font("Arial", 1, 12)); // NOI18N
        jLabel20.setForeground(new Color(0, 51, 153));
        jLabel20.setText("Projects in workspace:");
        jPanel91.add(jLabel20, BorderLayout.SOUTH);

        jPanel47.add(jPanel91, BorderLayout.PAGE_START);

        jPanel88.add(jPanel47, BorderLayout.CENTER);

        jPanel_NAV_Card1.add(jPanel88, BorderLayout.CENTER);

        jPanel_NAV_CardContainer.add(jPanel_NAV_Card1, "card4");

        jPanel_NAV_Card2.setBackground(new Color(0, 51, 102));
        jPanel_NAV_Card2.setBorder(BorderFactory.createMatteBorder(1, 2, 1, 1,
                new Color(0, 0, 51)));
        jPanel_NAV_Card2.setPreferredSize(new Dimension(0, 0));
        jPanel_NAV_Card2.setLayout(new BorderLayout());

        jPanel8_topBar1.setBackground(new Color(0, 51, 102));
        jPanel8_topBar1.setLayout(new BorderLayout());

        jLabel32.setBackground(new Color(0, 51, 102));
        jLabel32.setFont(new Font("Calibri", 1, 13)); // NOI18N
        jLabel32.setForeground(new Color(204, 204, 204));
        jLabel32.setText("DOCUMENTS");
        jLabel32.setMaximumSize(new Dimension(5000, 19));
        jLabel32.setMinimumSize(new Dimension(1, 1));
        jLabel32.setPreferredSize(new Dimension(200, 19));
        jLabel32.setRequestFocusEnabled(false);
        jLabel32.setVerifyInputWhenFocusTarget(false);
        jPanel8_topBar1.add(jLabel32, BorderLayout.CENTER);

        jPanel_NAV_Card2.add(jPanel8_topBar1, BorderLayout.NORTH);

        jPanel8_bottomBar1.setBackground(new Color(237, 237, 237));
        ...
        jButton_AddClinicalTexts.setHorizontalTextPosition(SwingConstants.RIGHT);
        jButton_AddClinicalTexts.setMaximumSize(new Dimension(100, 27));
        jButton_AddClinicalTexts.setMinimumSize(new Dimension(100, 27));
        jButton_AddClinicalTexts.setPreferredSize(new Dimension(100, 27));
        jButton_AddClinicalTexts.setVerticalAlignment(SwingConstants.BOTTOM);
        jButton_AddClinicalTexts.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton2.setPreferredSize(new Dimension(77, 30));
        ...
        jPanel_NAV_Card2.add(jPanel8_bottomBar1, BorderLayout.SOUTH);

        jPanel_corpuslist_outline.setBackground(new Color(237, 237, 237));
        jPanel_corpuslist_outline.setBorder(BorderFactory.createLineBorder(
                new Color(238, 239, 240), 2));
        jPanel_corpuslist_outline.setLayout(new BorderLayout());

        jPanel_corpuslist_innerline.setBackground(new Color(238, 238, 239));
        jPanel_corpuslist_innerline.setBorder(BorderFactory
                .createLineBorder(new Color(51, 51, 51)));
        jPanel_corpuslist_innerline.setLayout(new BorderLayout());

        jPanel99.setBackground(new Color(255, 255, 255));
        jPanel99.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1,
                new Color(238, 238, 237)));
        jPanel99.setLayout(new BorderLayout());
        ...
        jPanel99.add(jLabel21, BorderLayout.CENTER);

        jPanel_corpuslist_innerline.add(jPanel99, BorderLayout.NORTH);

        jScrollPane12.setBorder(null);
        jScrollPane12
                .setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);

        jList_corpus.setFont(new Font("Verdana", 0, 12)); // NOI18N
        jList_corpus.setModel(new AbstractListModel() {
            String[] strings = {"Item 1", "Item 2", "Item 3", "Item 4", "Item 5"};
        ...
        jPanel_corpuslist_innerline.add(jScrollPane12, BorderLayout.CENTER);

        jPanel_corpuslist_outline.add(jPanel_corpuslist_innerline, BorderLayout.CENTER);

        jPanel_NAV_Card2.add(jPanel_corpuslist_outline, BorderLayout.CENTER);

        jPanel_NAV_CardContainer.add(jPanel_NAV_Card2, "card3");

        jPanel_NAV_Card3.setBorder(BorderFactory.createMatteBorder(1, 2, 1, 1,
                new Color(0, 0, 51)));
        jPanel_NAV_Card3.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {
                jPanel_NAV_Card3MousePressed(evt);
            }
        });
        jPanel_NAV_Card3.setLayout(new BorderLayout());

        jPanel_colorfulTextBar_filebrowser6.setBackground(new Color(0, 102, 204));
        jPanel_colorfulTextBar_filebrowser6.setLayout(new BorderLayout());

        jLabel28.setBackground(new Color(0, 102, 204));
        jLabel28.setFont(new Font("Calibri", 1, 13)); // NOI18N
        jLabel28.setForeground(new Color(255, 255, 255));
        jLabel28.setText(" NAVIGATOR");
        jLabel28.setMaximumSize(new Dimension(5000, 19));
        jLabel28.setMinimumSize(new Dimension(1, 1));
        jLabel28.setPreferredSize(new Dimension(200, 19));
        jLabel28.setRequestFocusEnabled(false);
        jLabel28.setVerifyInputWhenFocusTarget(false);
        jPanel_colorfulTextBar_filebrowser6.add(jLabel28, BorderLayout.CENTER);

        jToolBar5.setBackground(new Color(237, 237, 237));
        jToolBar5.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jButton23.setPreferredSize(new Dimension(23, 23));
        jButton23.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        jButton16.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        jToggleButton_sequence_inLocation.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jToggleButton_sequence_inCharacters
                .setVerticalTextPosition(SwingConstants.BOTTOM);
        jToggleButton_sequence_inCharacters.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel_colorfulTextBar_filebrowser6.add(jToolBar5, BorderLayout.SOUTH);

        jPanel_NAV_Card3.add(jPanel_colorfulTextBar_filebrowser6, BorderLayout.NORTH);

        jPanel57.setBackground(new Color(237, 237, 237));
        jPanel57.setLayout(new GridLayout(1, 0));

        buttonGroup_treeview.add(jRadioButton_treeview_currentarticle);
        jRadioButton_treeview_currentarticle.setFont(new Font("Calibri", 0, 11)); // NOI18N
        jRadioButton_treeview_currentarticle.setSelected(true);
        jRadioButton_treeview_currentarticle.setText("Current Note");
        jRadioButton_treeview_currentarticle.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jRadioButton_treeview_overall.setFont(new Font("Calibri", 0, 11)); // NOI18N
        jRadioButton_treeview_overall.setText("All Notes");
        jRadioButton_treeview_overall.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel_NAV_Card3.add(jPanel57, BorderLayout.SOUTH);

        jScrollPane_classtree.setBorder(BorderFactory.createMatteBorder(2, 0, 2, 0,
                new Color(0, 102, 204)));
        jScrollPane_classtree
                .setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);

        jTree_class.setFont(new Font("Calibri", 0, 12)); // NOI18N
        ...
        jTree_class.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent evt) {
        ...
        jPanel_NAV_Card3.add(jScrollPane_classtree, BorderLayout.CENTER);

        jPanel_NAV_CardContainer.add(jPanel_NAV_Card3, "card2");

        NavigationPanel1.add(jPanel_NAV_CardContainer, BorderLayout.CENTER);

        Editor.add(NavigationPanel1, BorderLayout.WEST);

        jCardcontainer_interactive.setLayout(new CardLayout());

        jPanel_NLP.setBackground(new Color(237, 237, 237));
        jPanel_NLP.setForeground(new Color(215, 211, 210));
        jPanel_NLP.setLayout(new BorderLayout());
        jCardcontainer_interactive.add(jPanel_NLP, "card2");

        jSplitPane_between_viewer_and_allatttibutes
        ...
        jPanel_interactive_left.setMinimumSize(new Dimension(1, 1));
        jPanel_interactive_left.setPreferredSize(new Dimension(200, 166));
        jPanel_interactive_left.setLayout(new BorderLayout());

        jPanel73.setBackground(new Color(237, 237, 237));
        jPanel73.setBorder(BorderFactory.createLineBorder(new Color(238, 238,
                238), 3));
        jPanel73.setLayout(new BorderLayout());

        NavigationPanel_editor.setBorder(BorderFactory.createEtchedBorder());
        NavigationPanel_editor.setMaximumSize(new Dimension(21, 0));
        NavigationPanel_editor.setPreferredSize(new Dimension(21, 635));

        org.jdesktop.layout.GroupLayout NavigationPanel_editorLayout = new org.jdesktop.layout.GroupLayout(
                NavigationPanel_editor);
        NavigationPanel_editor.setLayout(NavigationPanel_editorLayout);
        NavigationPanel_editorLayout.setHorizontalGroup(NavigationPanel_editorLayout
                .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 17,
                        Short.MAX_VALUE));
        NavigationPanel_editorLayout.setVerticalGroup(NavigationPanel_editorLayout
                .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 786,
                        Short.MAX_VALUE));

        jPanel73.add(NavigationPanel_editor, BorderLayout.EAST);

        jPanel12.setBackground(new Color(238, 238, 237));
        jPanel12.setLayout(new BorderLayout());

        jPanel37.setBackground(new Color(236, 233, 216));
        jPanel37.setLayout(new BorderLayout());

        jPanel_colorfulTextBar_filebrowser2.setBackground(new Color(41, 119, 167));
        jPanel_colorfulTextBar_filebrowser2.setLayout(new BorderLayout());

        jLabel25.setBackground(new Color(41, 119, 167));
        jLabel25.setFont(new Font("Calibri", 1, 13)); // NOI18N
        jLabel25.setForeground(new Color(230, 230, 230));
        jLabel25.setText("  Document Viewer");
        jLabel25.setMaximumSize(new Dimension(5000, 19));
        jLabel25.setMinimumSize(new Dimension(1, 1));
        jLabel25.setPreferredSize(new Dimension(200, 19));
        ...
        jPanel_colorfulTextBar_filebrowser2.add(jLabel25, BorderLayout.CENTER);

        jPanel37.add(jPanel_colorfulTextBar_filebrowser2, BorderLayout.NORTH);

        jPanel8.setBackground(new Color(236, 233, 216));
        jPanel8.setLayout(new BorderLayout());

        jToolBar3.setBackground(new Color(237, 237, 237));
        jToolBar3.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jComboBox_InputFileList.setFont(new Font("Verdana", 0, 12)); // NOI18N
        jComboBox_InputFileList.setModel(new DefaultComboBoxModel(new String[]{
        ...
        jButton13.setMinimumSize(new Dimension(23, 23));
        jButton13.setPreferredSize(new Dimension(23, 23));
        ...
        jButton14.setMaximumSize(new Dimension(23, 23));
        jButton14.setMinimumSize(new Dimension(23, 23));
        jButton14.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        jButton_importAnnotations.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton_importAnnotations.setMaximumSize(new Dimension(23, 23));
        jButton_importAnnotations.setPreferredSize(new Dimension(23, 23));
        jButton_importAnnotations.setVerticalTextPosition(SwingConstants.BOTTOM);
        jButton_importAnnotations.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_removeduplicates.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton_removeduplicates.setMaximumSize(new Dimension(23, 23));
        jButton_removeduplicates.setMinimumSize(new Dimension(23, 23));
        jButton_removeduplicates.setPreferredSize(new Dimension(23, 23));
        jButton_removeduplicates.setVerticalTextPosition(SwingConstants.BOTTOM);
        jButton_removeduplicates.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_save.setMaximumSize(new Dimension(23, 23));
        ...
        jButton20.setMaximumSize(new Dimension(23, 23));
        jButton20.setMinimumSize(new Dimension(23, 23));
        jButton20.setPreferredSize(new Dimension(23, 23));
        jButton20.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        jButton21.setMaximumSize(new Dimension(23, 23));
        jButton21.setMinimumSize(new Dimension(23, 23));
        jButton21.setPreferredSize(new Dimension(23, 23));
        jButton21.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        jButton22.setMaximumSize(new Dimension(23, 23));
        jButton22.setMinimumSize(new Dimension(23, 23));
        jButton22.setPreferredSize(new Dimension(23, 23));
        jButton22.setVerticalTextPosition(SwingConstants.BOTTOM);
        ...
        jButton_removeAllAnnotations.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton_removeAllAnnotations.setMaximumSize(new Dimension(23, 23));
        jButton_removeAllAnnotations.setMinimumSize(new Dimension(23, 23));
        jButton_removeAllAnnotations.setPreferredSize(new Dimension(23, 23));
        jButton_removeAllAnnotations.setVerticalTextPosition(SwingConstants.BOTTOM);
        jButton_removeAllAnnotations.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_save1.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton_save1.setMaximumSize(new Dimension(23, 23));
        jButton_save1.setMinimumSize(new Dimension(23, 23));
        jButton_save1.setPreferredSize(new Dimension(23, 23));
        jButton_save1.setVerticalTextPosition(SwingConstants.BOTTOM);
        jButton_save1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_importAnnotations1.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton_importAnnotations1.setMaximumSize(new Dimension(23, 23));
        jButton_importAnnotations1.setPreferredSize(new Dimension(23, 23));
        jButton_importAnnotations1.setVerticalTextPosition(SwingConstants.BOTTOM);
        jButton_importAnnotations1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel8.add(jToolBar3, BorderLayout.CENTER);

        jPanel37.add(jPanel8, BorderLayout.CENTER);

        jPanel24.setBackground(new Color(236, 233, 216));
        jPanel24.setLayout(new BorderLayout());

        jToolBar6.setBackground(new Color(237, 237, 237));
        jToolBar6.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jToolBar6.addMouseMotionListener(new MouseMotionAdapter() {
            public void mouseMoved(MouseEvent evt) {
                jToolBar6MouseMoved(evt);
            }
        });

        jLabel4.setBackground(new Color(238, 238, 239));
        ...
        jButton18.setBorder(BorderFactory
                .createLineBorder(new Color(51, 51, 0)));
        jButton18.setHorizontalAlignment(SwingConstants.LEFT);
        jButton18.setMaximumSize(new Dimension(83, 23));
        jButton18.setMinimumSize(new Dimension(83, 23));
        jButton18.setPreferredSize(new Dimension(83, 23));
        ...
        jLabel23.setFont(new Font("Times New Roman", 0, 13)); // NOI18N
        ...
        jButton19.setMaximumSize(new Dimension(93, 23));
        jButton19.setMinimumSize(new Dimension(93, 23));
        jButton19.setPreferredSize(new Dimension(93, 23));
        ...
        jPanel24.add(jToolBar6, BorderLayout.CENTER);

        jPanel37.add(jPanel24, BorderLayout.SOUTH);

        jPanel12.add(jPanel37, BorderLayout.PAGE_START);

        jTabbedPane3.setBackground(new Color(238, 238, 237));
        jTabbedPane3.setForeground(new Color(102, 102, 102));
        jTabbedPane3.setFont(new Font("Verdana", 0, 12)); // NOI18N
        ...
        jPanel36.setBackground(new Color(236, 233, 216));
        jPanel36.setMinimumSize(new Dimension(1, 1));
        jPanel36.setPreferredSize(new Dimension(200, 122));
        jPanel36.setLayout(new BorderLayout());

        jPanel43.setBackground(new Color(237, 237, 237));
        jPanel43.setMinimumSize(new Dimension(1, 1));
        jPanel43.setPreferredSize(new Dimension(200, 36));
        jPanel43.setLayout(new BorderLayout());

        jLabel_cursor.setForeground(new Color(102, 102, 102));
        jPanel43.add(jLabel_cursor, BorderLayout.CENTER);

        jPanel38.setBackground(new Color(237, 237, 237));
        jPanel38.setLayout(new BorderLayout());

        jTextField_searchtext.setBackground(new Color(237, 237, 237));
        jTextField_searchtext.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent evt) {
                jTextField_searchtextKeyTyped(evt);
            }
        });
        jPanel38.add(jTextField_searchtext, BorderLayout.CENTER);

        jButton1.setBackground(new Color(237, 237, 237));
        ...
        jPanel38.add(jButton1, BorderLayout.EAST);

        jPanel43.add(jPanel38, BorderLayout.NORTH);

        jPanel36.add(jPanel43, BorderLayout.SOUTH);

        jPanel46.setBackground(new Color(237, 237, 237));
        jPanel46.setLayout(new BorderLayout());

        jScrollPane_textpane.setBorder(null);

        textPaneforClinicalNotes.setBorder(BorderFactory.createMatteBorder(4, 1, 4, 1,
                new Color(255, 255, 255)));
        textPaneforClinicalNotes.setFont(new Font("Georgia", 0, 12)); // NOI18N
        textPaneforClinicalNotes.setDoubleBuffered(true);
        textPaneforClinicalNotes.setDropMode(DropMode.INSERT);
        textPaneforClinicalNotes.setMinimumSize(new Dimension(1, 1));
        textPaneforClinicalNotes.setPreferredSize(new Dimension(200, 20));
        textPaneforClinicalNotes.addMouseListener(new MouseAdapter() {
            public void mouseReleased(MouseEvent evt) {
                textPaneforClinicalNotesMouseReleased(evt);
            }
        });
        textPaneforClinicalNotes.addKeyListener(new KeyAdapter() {
        ...
        jPanel46.add(jScrollPane_textpane, BorderLayout.CENTER);

        jPanel_position_indicator_container.setBackground(new Color(237, 237, 237));
        jPanel_position_indicator_container.setMinimumSize(new Dimension(20, 0));
        jPanel_position_indicator_container.setPreferredSize(new Dimension(20, 0));
        jPanel_position_indicator_container.setLayout(new BorderLayout());
        jPanel46.add(jPanel_position_indicator_container, BorderLayout.EAST);

        jPanel36.add(jPanel46, BorderLayout.CENTER);

        jTabbedPane3.addTab("Text Display", jPanel36);

        jPanel77.setLayout(new BorderLayout());

        jPanel78.setBackground(new Color(237, 237, 237));
        jPanel78.setLayout(new BorderLayout());

        jPanel79.setBackground(new Color(237, 237, 237));
        jPanel79.setLayout(new BorderLayout());

        jPanel80.setBackground(new Color(237, 237, 237));
        jPanel80.setLayout(new GridLayout(8, 1, 7, 7));

        jPanel82.setBackground(new Color(237, 237, 237));
        jPanel82.setLayout(new BorderLayout());

        jLabel26.setFont(new Font("Calibri", 1, 14)); // NOI18N
        jLabel26.setText("Current Document Summary");
        jPanel82.add(jLabel26, BorderLayout.CENTER);

        jPanel80.add(jPanel82);

        classes.setFont(new Font("Calibri", 0, 12)); // NOI18N
        ...
        annotations.setFont(new Font("Calibri", 0, 12)); // NOI18N
        annotations.setText("Number of Annotations:");
        annotations.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        annotators.setFont(new Font("Calibri", 0, 12)); // NOI18N
        annotators.setText("Number of Annotators:");
        annotators.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        overlapping.setFont(new Font("Calibri", 0, 12)); // NOI18N
        overlapping.setText("Overlapping Annotations:");
        overlapping.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        workingConflicts.setFont(new Font("Calibri", 0, 12)); // NOI18N
        workingConflicts.setText("Annotations in Conflict with Working Set: ");
        workingConflicts.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        jPanel86.setBackground(new Color(237, 237, 237));
        jPanel86.setLayout(new GridLayout(1, 0));

        jPanel92.setBackground(new Color(237, 237, 237));
        jPanel92.setLayout(new BorderLayout());

        verifierFlagged.setText("Annotations Flagged by Verifier:");
        verifierFlagged.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                verifierFlaggedMouseClicked(evt);
            }
        });
        jPanel92.add(verifierFlagged, BorderLayout.CENTER);

        jPanel86.add(jPanel92);

        jPanel90.setBackground(new Color(237, 237, 237));
        jPanel90.setLayout(new GridLayout(1, 0));

        verifierOnCurrent.setFont(new Font("Calibri", 0, 11)); // NOI18N
        verifierOnCurrent.setText("Run Verifier(Current)");
        verifierOnCurrent.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        verifierOnAll.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel81.setBackground(new Color(237, 237, 237));
        jPanel81.setLayout(new GridLayout(1, 2));

        jLabel1.setFont(new Font("Calibri", 0, 12)); // NOI18N
        jLabel1.setHorizontalAlignment(SwingConstants.RIGHT);
        jLabel1.setText("Currently Viewing:  ");
        jPanel81.add(jLabel1);

        jLabel29.setFont(new Font("Calibri", 0, 12)); // NOI18N
        jPanel81.add(jLabel29);

        jPanel80.add(jPanel81);

        jPanel79.add(jPanel80, BorderLayout.CENTER);

        jPanel78.add(jPanel79, BorderLayout.PAGE_START);

        jScrollPane4.setBackground(new Color(237, 237, 237));
        ...
        infoList.addMouseMotionListener(new MouseMotionAdapter() {
            public void mouseMoved(MouseEvent evt) {
        ...
        jPanel78.add(jScrollPane4, BorderLayout.CENTER);

        jPanel83.setBackground(new Color(237, 237, 237));
        jPanel83.setLayout(new GridLayout(1, 0));

        displayCurrent.setFont(new Font("Calibri", 0, 12)); // NOI18N
        ...
        refresh.setFont(new Font("Calibri", 0, 12)); // NOI18N
        ...
        jPanel78.add(jPanel83, BorderLayout.PAGE_END);

        jPanel77.add(jPanel78, BorderLayout.CENTER);

        jTabbedPane3.addTab("Annotation Information", jPanel77);

        jPanel_reportFormContainer.setBackground(new Color(237, 237, 237));

        org.jdesktop.layout.GroupLayout jPanel_reportFormContainerLayout = new org.jdesktop.layout.GroupLayout(
                jPanel_reportFormContainer);
        jPanel_reportFormContainer.setLayout(jPanel_reportFormContainerLayout);
        jPanel_reportFormContainerLayout.setHorizontalGroup(jPanel_reportFormContainerLayout
                .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 652,
                        Short.MAX_VALUE));
        jPanel_reportFormContainerLayout.setVerticalGroup(jPanel_reportFormContainerLayout
                .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 675,
                        Short.MAX_VALUE));

        jTabbedPane3.addTab("Reports", jPanel_reportFormContainer);

        jPanel12.add(jTabbedPane3, BorderLayout.CENTER);

        jPanel73.add(jPanel12, BorderLayout.CENTER);

        jPanel_interactive_left.add(jPanel73, BorderLayout.CENTER);

        jSplitPane_between_viewer_and_allatttibutes.setLeftComponent(jPanel_interactive_left);

        jPanel_MainFrame_Right.setBackground(new Color(238, 238, 237));
        jPanel_MainFrame_Right.setLayout(new GridLayout(1, 2, 4, 0));

        jPanel_EditorPanel.setBackground(new Color(237, 237, 237));
        jPanel_EditorPanel.setBorder(BorderFactory.createLineBorder(new Color(
                0, 0, 102)));
        jPanel_EditorPanel.setMaximumSize(new Dimension(4000, 4000));
        jPanel_EditorPanel.setMinimumSize(new Dimension(0, 0));
        jPanel_EditorPanel.setLayout(new BorderLayout());

        jPanel9.setMinimumSize(new Dimension(1, 1));
        jPanel9.setPreferredSize(new Dimension(319, 777));
        jPanel9.setLayout(new BorderLayout());

        jPanel5.setPreferredSize(new Dimension(257, 285));
        jPanel5.setLayout(new BorderLayout());

        jPanel40.setBackground(new Color(236, 233, 216));
        jPanel40.setPreferredSize(new Dimension(390, 180));
        jPanel40.setLayout(new BorderLayout());

        jPanel_colorfulTextBar_filebrowser3.setBackground(new Color(41, 119, 167));
        jPanel_colorfulTextBar_filebrowser3.setLayout(new BorderLayout());

        jLabel27.setBackground(new Color(41, 119, 167));
        jLabel27.setFont(new Font("Calibri", 1, 13)); // NOI18N
        jLabel27.setForeground(new Color(230, 230, 230));
        jLabel27.setText(" Annotation Editor");
        jLabel27.setHorizontalTextPosition(SwingConstants.CENTER);
        jLabel27.setMinimumSize(new Dimension(1, 1));
        jLabel27.setPreferredSize(new Dimension(200, 19));
        jLabel27.setRequestFocusEnabled(false);
        jLabel27.setVerifyInputWhenFocusTarget(false);
        jPanel_colorfulTextBar_filebrowser3.add(jLabel27, BorderLayout.NORTH);

        jPanel94.setLayout(new BorderLayout());

        jToolBar_editopanel_comparison.setBackground(new Color(237, 237, 237));
        jToolBar_editopanel_comparison.setBorder(BorderFactory.createEmptyBorder(1, 1,
                1, 1));
        ...
        jToolBar_editopanel_comparison.setFont(new Font("Bangla MN", 0, 13)); // NOI18N
        jToolBar_editopanel_comparison.setMinimumSize(new Dimension(72, 26));
        jToolBar_editopanel_comparison.setPreferredSize(new Dimension(0, 26));
        ...
        jButton17.setFont(new Font("Verdana", 0, 12)); // NOI18N
        jButton17.setText("Accept");
        jButton17.setFocusable(false);
        jButton17.setMaximumSize(new Dimension(52, 24));
        jButton17.setMinimumSize(new Dimension(0, 24));
        jButton17.setPreferredSize(new Dimension(52, 24));
        ...
        jButton24.setFont(new Font("Verdana", 0, 12)); // NOI18N
        jButton24.setText("Reject");
        jButton24.setFocusable(false);
        jButton24.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton24.setMaximumSize(new Dimension(52, 24));
        jButton24.setMinimumSize(new Dimension(0, 24));
        jButton24.setPreferredSize(new Dimension(52, 24));
        ...
        jButton9.setFont(new Font("Verdana", 0, 12)); // NOI18N
        jButton9.setText("AcceptAll");
        jButton9.setFocusable(false);
        jButton9.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton9.setMaximumSize(new Dimension(70, 24));
        jButton9.setMinimumSize(new Dimension(70, 24));
        jButton9.setPreferredSize(new Dimension(70, 24));
        ...
        jPanel94.add(jToolBar_editopanel_comparison, BorderLayout.SOUTH);

        jPanel42.setMaximumSize(new Dimension(2147483647, 26));
        jPanel42.setMinimumSize(new Dimension(50, 26));
        jPanel42.setPreferredSize(new Dimension(138, 26));
        jPanel42.setLayout(new BorderLayout());

        jToolBar4.setBackground(new Color(237, 237, 237));
        jToolBar4.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jButton_spaneditor_delete.setMaximumSize(new Dimension(23, 23));
        jButton_spaneditor_delete.setMinimumSize(new Dimension(23, 23));
        jButton_spaneditor_delete.setPreferredSize(new Dimension(23, 23));
        jButton_spaneditor_delete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_spaneditor_lefttToLeft.setMaximumSize(new Dimension(28, 23));
        jButton_spaneditor_lefttToLeft.setMinimumSize(new Dimension(28, 23));
        jButton_spaneditor_lefttToLeft.setPreferredSize(new Dimension(28, 23));
        jButton_spaneditor_lefttToLeft.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_spaneditor_leftToRight.setMaximumSize(new Dimension(28, 23));
        jButton_spaneditor_leftToRight.setMinimumSize(new Dimension(28, 23));
        jButton_spaneditor_leftToRight.setPreferredSize(new Dimension(28, 23));
        jButton_spaneditor_leftToRight.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_span_rightToLeft.setHorizontalTextPosition(SwingConstants.CENTER);
        jButton_span_rightToLeft.setMaximumSize(new Dimension(28, 23));
        jButton_span_rightToLeft.setMinimumSize(new Dimension(28, 23));
        jButton_span_rightToLeft.setPreferredSize(new Dimension(28, 23));
        jButton_span_rightToLeft.setVerticalTextPosition(SwingConstants.BOTTOM);
        jButton_span_rightToLeft.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton4_spanEditor_rightToRight.setMaximumSize(new Dimension(28, 23));
        jButton4_spanEditor_rightToRight.setMinimumSize(new Dimension(28, 23));
        jButton4_spanEditor_rightToRight.setPreferredSize(new Dimension(28, 23));
        jButton4_spanEditor_rightToRight.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel42.add(jToolBar4, BorderLayout.CENTER);

        jPanel59.setBackground(new Color(237, 237, 237));
        jPanel59.setLayout(new BorderLayout());

        jPanel60.setBackground(new Color(237, 237, 237));
        jPanel59.add(jPanel60, BorderLayout.CENTER);

        jPanel42.add(jPanel59, BorderLayout.EAST);

        jPanel94.add(jPanel42, BorderLayout.NORTH);

        jPanel_colorfulTextBar_filebrowser3.add(jPanel94, BorderLayout.CENTER);

        jPanel40.add(jPanel_colorfulTextBar_filebrowser3, BorderLayout.NORTH);

        jPanel41.setBackground(new Color(237, 237, 237));
        jPanel41.setMaximumSize(new Dimension(32767, 280));
        jPanel41.setMinimumSize(new Dimension(1, 1));
        jPanel41.setLayout(new BorderLayout());

        jPanel_multipleResultShowList.setBorder(BorderFactory.createLineBorder(
                new Color(240, 240, 240), 3));
        jPanel_multipleResultShowList.setMinimumSize(new Dimension(0, 0));
        jPanel_multipleResultShowList.setLayout(new BorderLayout());
        ...
        jList_selectedAnnotations.setBorder(BorderFactory.createEtchedBorder());
        jList_selectedAnnotations.setFont(new Font("Calibri", 0, 11)); // NOI18N
        jList_selectedAnnotations.setSelectionBackground(new Color(74, 136, 218));
        ...
        jPanel_multipleResultShowList.add(jScrollPane5, BorderLayout.CENTER);

        jPanel45.setBackground(new Color(237, 237, 237));

        jLabel12.setBackground(new Color(236, 233, 216));
        jLabel12.setFont(new Font("Verdana", 0, 11)); // NOI18N
        ...
        jLabel12.setMaximumSize(new Dimension(0, 25));
        jLabel12.setMinimumSize(new Dimension(0, 25));
        jLabel12.setPreferredSize(new Dimension(0, 16));
        jLabel12.setRequestFocusEnabled(false);
        jLabel12.setVerticalTextPosition(SwingConstants.BOTTOM);

        org.jdesktop.layout.GroupLayout jPanel45Layout = new org.jdesktop.layout.GroupLayout(
                jPanel45);
        ...
        jPanel45Layout.setHorizontalGroup(jPanel45Layout.createParallelGroup(
                ...
                jPanel45Layout
                        .createSequentialGroup()
                        .add(jLabel12, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 203,
                                org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel_multipleResultShowList.add(jPanel45, BorderLayout.NORTH);

        jPanel50.setBackground(new Color(237, 237, 237));
        jPanel50.setLayout(new GridLayout(2, 0, 0, 2));

        jPanel74.setLayout(new BorderLayout());
        jPanel50.add(jPanel74);

        jPanel_multipleResultShowList.add(jPanel50, BorderLayout.SOUTH);

        jPanel41.add(jPanel_multipleResultShowList, BorderLayout.CENTER);

        jPanel40.add(jPanel41, BorderLayout.CENTER);

        jPanel4.setBackground(new Color(165, 198, 230));
        jPanel4.setMaximumSize(new Dimension(32767, 1));
        jPanel4.setPreferredSize(new Dimension(0, 2));

        org.jdesktop.layout.GroupLayout jPanel4Layout = new org.jdesktop.layout.GroupLayout(jPanel4);
        jPanel4.setLayout(jPanel4Layout);
        jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(0, 239, Short.MAX_VALUE));
        jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(0, 2, Short.MAX_VALUE));

        jPanel40.add(jPanel4, BorderLayout.PAGE_END);

        jPanel5.add(jPanel40, BorderLayout.NORTH);

        jPanel7.setBackground(new Color(237, 237, 237));
        jPanel7.setLayout(new GridLayout(1, 2, 3, 0));

        jPanel_annotation_details.setBackground(new Color(240, 240, 240));
        jPanel_annotation_details.setBorder(BorderFactory.createLineBorder(
                new Color(240, 240, 240), 2));
        jPanel_annotation_details.setLayout(new BorderLayout());

        jLabel19.setBackground(new Color(236, 233, 216));
        jLabel19.setFont(new Font("Verdana", 0, 11)); // NOI18N
        jLabel19.setForeground(new Color(102, 102, 102));
        jLabel19.setText("Span:");
        jLabel19.setVerticalAlignment(SwingConstants.BOTTOM);
        jLabel19.setBorder(BorderFactory.createMatteBorder(4, 1, 1, 1,
                new Color(238, 238, 240)));
        jLabel19.setMaximumSize(new Dimension(0, 25));
        jLabel19.setMinimumSize(new Dimension(0, 25));
        jLabel19.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel_annotation_details.add(jLabel19, BorderLayout.NORTH);

        jPanel20.setLayout(new BorderLayout());

        jPanel21.setBackground(new Color(238, 238, 240));
        ...
        jButton_SpanAdd.setMaximumSize(new Dimension(28, 23));
        jButton_SpanAdd.setMinimumSize(new Dimension(1, 1));
        jButton_SpanAdd.setPreferredSize(new Dimension(23, 23));
        jButton_SpanAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_SpanRemove.setMaximumSize(new Dimension(28, 23));
        jButton_SpanRemove.setMinimumSize(new Dimension(1, 1));
        jButton_SpanRemove.setPreferredSize(new Dimension(23, 23));
        jButton_SpanRemove.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel21.add(jPanel23, BorderLayout.NORTH);

        jPanel20.add(jPanel21, BorderLayout.EAST);

        jScrollPane_Spans.setBorder(BorderFactory.createLineBorder(new Color(
                153, 153, 153)));

        jList_Spans.setFont(new Font("Calibri", 0, 12)); // NOI18N
        ...
        jPanel20.add(jScrollPane_Spans, BorderLayout.CENTER);

        jPanel_annotation_details.add(jPanel20, BorderLayout.CENTER);
        ...
        org.jdesktop.layout.GroupLayout jPanel64Layout = new org.jdesktop.layout.GroupLayout(
                jPanel64);
        jPanel64.setLayout(jPanel64Layout);
        jPanel64Layout.setHorizontalGroup(jPanel64Layout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(0, 118, Short.MAX_VALUE));
        jPanel64Layout.setVerticalGroup(jPanel64Layout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(0, 0, Short.MAX_VALUE));

        jPanel19.add(jPanel64, BorderLayout.NORTH);

        jPanel65.setBackground(new Color(237, 237, 237));
        jPanel65.setLayout(new BorderLayout());

        jPanel55.setBackground(new Color(237, 237, 237));
        jPanel55.setMaximumSize(new Dimension(2147483647, 70));
        jPanel55.setPreferredSize(new Dimension(0, 72));
        jPanel55.setLayout(new BorderLayout());

        jPanel39.setBackground(new Color(237, 237, 237));
        jPanel39.setBorder(BorderFactory.createLineBorder(new Color(240, 240,
                240), 2));
        jPanel39.setMaximumSize(new Dimension(32767, 112));
        jPanel39.setMinimumSize(new Dimension(0, 0));
        jPanel39.setPreferredSize(new Dimension(0, 67));
        jPanel39.setLayout(new GridLayout(3, 0, 0, 2));

        jLabel16.setBackground(new Color(236, 233, 216));
        jLabel16.setFont(new Font("Verdana", 0, 11)); // NOI18N
        jLabel16.setForeground(new Color(102, 102, 102));
        jLabel16.setText("Class:");
        jLabel16.setVerticalAlignment(SwingConstants.BOTTOM);
        jLabel16.setMaximumSize(new Dimension(0, 25));
        jLabel16.setMinimumSize(new Dimension(0, 25));
        jLabel16.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel39.add(jLabel16);

        jPanel44.setBackground(new Color(237, 237, 237));
        jPanel44.setLayout(new BorderLayout());

        jTextField_annotationClassnames.setFont(new Font("Calibri", 0, 12)); // NOI18N
        jTextField_annotationClassnames.setBorder(BorderFactory
                .createLineBorder(new Color(102, 102, 102)));
        jTextField_annotationClassnames.setDisabledTextColor(new Color(0, 0, 0));
        ...
        jButton_SelectClass.setMargin(new Insets(2, 2, 2, 2));
        jButton_SelectClass.setPreferredSize(new Dimension(20, 20));
        jButton_SelectClass.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                jButton_SelectClassActionPerformed(evt);
            }
        });
        jPanel44.add(jButton_SelectClass, BorderLayout.EAST);

        jPanel39.add(jPanel44);

        jLabel38.setBackground(new Color(236, 233, 216));
        jLabel38.setFont(new Font("Verdana", 0, 11)); // NOI18N
        jLabel38.setForeground(new Color(102, 102, 102));
        jLabel38.setText("Comment:");
        jLabel38.setVerticalAlignment(SwingConstants.BOTTOM);
        jLabel38.setMaximumSize(new Dimension(0, 25));
        jLabel38.setMinimumSize(new Dimension(0, 25));
        jLabel38.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel39.add(jLabel38);

        jPanel55.add(jPanel39, BorderLayout.CENTER);

        jPanel65.add(jPanel55, BorderLayout.NORTH);

        jPanel66.setBorder(BorderFactory.createLineBorder(new Color(240, 240,
                240), 2));
        jPanel66.setLayout(new BorderLayout());

        jScrollPane2.setBorder(null);
        jScrollPane2.setViewportBorder(BorderFactory.createEtchedBorder());

        jTextArea_comment.setBackground(new Color(240, 240, 240));
        jTextArea_comment.setColumns(20);
        jTextArea_comment.setEditable(false);
        jTextArea_comment.setFont(new Font("Calibri", 0, 12)); // NOI18N
        jTextArea_comment.setLineWrap(true);
        jTextArea_comment.setRows(5);
        jTextArea_comment.setBorder(null);
        jTextArea_comment.setDisabledTextColor(new Color(0, 1, 0));
        jTextArea_comment.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                jTextArea_commentMouseClicked(evt);
            }
        });
        jTextArea_comment.addFocusListener(new FocusAdapter() {
        ...
        jPanel66.add(jScrollPane2, BorderLayout.CENTER);

        jPanel65.add(jPanel66, BorderLayout.CENTER);

        jPanel19.add(jPanel65, BorderLayout.CENTER);

        jPanel7.add(jPanel19);

        jPanel5.add(jPanel7, BorderLayout.CENTER);

        jPanel9.add(jPanel5, BorderLayout.NORTH);

        jSplitPane5.setBackground(new Color(237, 237, 237));
        ...
        jPanel48.setBackground(new Color(237, 237, 237));
        jPanel48.setBorder(BorderFactory.createLineBorder(new Color(240, 240,
                240), 2));
        jPanel48.setMinimumSize(new Dimension(1, 1));
        jPanel48.setPreferredSize(new Dimension(439, 200));
        jPanel48.setLayout(new GridLayout(2, 0, 0, 2));

        jPanel70.setLayout(new BorderLayout());

        jPanel61.setBackground(new Color(237, 237, 237));
        jPanel61.setLayout(new BorderLayout());

        jLabel39.setBackground(new Color(236, 233, 216));
        jLabel39.setFont(new Font("Verdana", 0, 11)); // NOI18N
        ...
        jLabel39.setMaximumSize(new Dimension(0, 25));
        jLabel39.setMinimumSize(new Dimension(0, 25));
        jLabel39.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel61.add(jLabel39, BorderLayout.CENTER);

        jPanel18.setBackground(new Color(238, 238, 239));
        ...
        delete_Relationships.setMinimumSize(new Dimension(23, 23));
        delete_Relationships.setPreferredSize(new Dimension(21, 21));
        delete_Relationships.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButton_relationships.setPreferredSize(new Dimension(20, 20));
        jButton_relationships.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel61.add(jPanel18, BorderLayout.EAST);

        jPanel70.add(jPanel61, BorderLayout.NORTH);
        ...
        jList_complexrelationships.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                jList_complexrelationshipsMouseClicked(evt);
            }
        });
        jList_complexrelationships
                .addListSelectionListener(new javax.swing.event.ListSelectionListener() {
                    public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
        ...
        jPanel70.add(jScrollPane8, BorderLayout.CENTER);

        jPanel48.add(jPanel70);

        jPanel71.setLayout(new BorderLayout());
        ...
        jButton_attribute.setPreferredSize(new Dimension(20, 20));
        jButton_attribute.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                jButton_attributeActionPerformed(evt);
            }
        });
        jPanel63.add(jButton_attribute, BorderLayout.EAST);

        jLabel40.setFont(new Font("Verdana", 0, 11)); // NOI18N
        ...
        jLabel40.setMinimumSize(new Dimension(0, 25));
        jLabel40.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel63.add(jLabel40, BorderLayout.CENTER);

        jPanel71.add(jPanel63, BorderLayout.NORTH);
        ...
        jList_normalrelationship.setFont(new Font("Calibri", 0, 12)); // NOI18N
        jList_normalrelationship.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
        ...
        jPanel71.add(jScrollPane9, BorderLayout.CENTER);

        jPanel48.add(jPanel71);

        jSplitPane5.setLeftComponent(jPanel48);

        jPanel75.setBackground(new Color(237, 237, 237));
        jPanel75.setLayout(new BorderLayout());

        jPanel76.setBackground(new Color(237, 237, 237));
        jPanel76.setLayout(new GridLayout(2, 2, 2, 2));

        jLabel37.setBackground(new Color(236, 233, 216));
        jLabel37.setFont(new Font("Verdana", 0, 11)); // NOI18N
        ...
        jLabel37.setMaximumSize(new Dimension(0, 16));
        jLabel37.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel76.add(jLabel37);

        jLabel33.setBackground(new Color(236, 233, 216));
        jLabel33.setFont(new Font("Verdana", 0, 11)); // NOI18N
        ...
        jLabel33.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel76.add(jLabel33);

        jTextField_creationdate.setFont(new Font("Calibri", 0, 12)); // NOI18N
        jTextField_creationdate.setDisabledTextColor(new Color(0, 0, 0));
        jTextField_creationdate.setMaximumSize(new Dimension(0, 16));
        jTextField_creationdate.setMinimumSize(new Dimension(0, 0));
        jPanel76.add(jTextField_creationdate);

        jTextField_annotator.setFont(new Font("Calibri", 0, 12)); // NOI18N
        jTextField_annotator.setDisabledTextColor(new Color(0, 0, 0));
        jTextField_annotator.setMaximumSize(new Dimension(0, 16));
        jTextField_annotator.setMinimumSize(new Dimension(0, 0));
        jTextField_annotator.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                jTextField_annotatorMouseClicked(evt);
            }
        });
        jTextField_annotator.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent evt) {
        ...
        jPanel75.add(jPanel76, BorderLayout.NORTH);

        jPanel87.setLayout(new BorderLayout());

        jPanel84.setBackground(new Color(238, 238, 237));
        jPanel84.setLayout(new GridLayout(1, 2, 2, 0));

        jPanel68.setBackground(new Color(237, 237, 237));
        jPanel68.setMinimumSize(new Dimension(1, 1));
        jPanel68.setLayout(new BorderLayout());

        jTabbedPane1.setBackground(new Color(236, 233, 216));
        jTabbedPane1.setFont(new Font("Calibri", 0, 11)); // NOI18N
        jTabbedPane1.setMaximumSize(new Dimension(32767, 320));
        jTabbedPane1.setMinimumSize(new Dimension(1, 1));

        jPanel6.setLayout(new BorderLayout());

        jList3.setFont(new Font("Calibri", 0, 11)); // NOI18N
        jList3.setMaximumSize(new Dimension(1, 1));
        jList3.setMinimumSize(new Dimension(1, 1));
        ...
        jTextPane_explanations.setMinimumSize(new Dimension(1, 1));
        jScrollPane7.setViewportView(jTextPane_explanations);

        jPanel27.add(jScrollPane7, BorderLayout.CENTER);

        jTabbedPane1.addTab("Rule Explanations", jPanel27);

        jPanel68.add(jTabbedPane1, BorderLayout.CENTER);

        jPanel_colorfulTextBar_filebrowser4.setBackground(new Color(41, 119, 167));
        jPanel_colorfulTextBar_filebrowser4.setLayout(new BorderLayout());
        jPanel68.add(jPanel_colorfulTextBar_filebrowser4, BorderLayout.NORTH);

        jPanel69.setBackground(new Color(237, 237, 237));
        jPanel69.setMinimumSize(new Dimension(1, 1));
        jPanel69.setLayout(new GridLayout(1, 0, 4, 4));

        jButton12.setFont(new Font("Calibri", 0, 11)); // NOI18N
        jButton12.setText("Set Annotation To Selected");
        jButton12
                .setToolTipText("<html>Modify the selected annotation to match<br> the currently selected suggestion</html>");
        ...
        jPanel68.add(jPanel69, BorderLayout.SOUTH);

        jPanel84.add(jPanel68);

        jPanel72.setBackground(new Color(237, 237, 237));
        jPanel72.setBorder(BorderFactory.createLineBorder(new Color(240, 240,
                240), 2));
        jPanel72.setMinimumSize(new Dimension(1, 1));
        jPanel72.setLayout(new BorderLayout());

        jLabel41.setFont(new Font("Calibri", 0, 11)); // NOI18N
        jLabel41.setForeground(new Color(153, 153, 153));
        jLabel41.setText("Saved Verify Suggestion:");
        jLabel41.setVerticalAlignment(SwingConstants.BOTTOM);
        jLabel41.setMaximumSize(new Dimension(0, 25));
        jLabel41.setMinimumSize(new Dimension(0, 25));
        jLabel41.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel72.add(jLabel41, BorderLayout.NORTH);

        jPanel84.add(jPanel72);

        jPanel87.add(jPanel84, BorderLayout.CENTER);

        jPanel_colorfulTextBar_filebrowser7.setBackground(new Color(41, 119, 167));
        jPanel_colorfulTextBar_filebrowser7.setLayout(new BorderLayout());

        jLabel42.setBackground(new Color(41, 119, 167));
        jLabel42.setFont(new Font("Calibri", 1, 13)); // NOI18N
        jLabel42.setForeground(new Color(255, 255, 255));
        jLabel42.setText("  VERIFIER");
        jLabel42.setMaximumSize(new Dimension(5000, 19));
        jLabel42.setMinimumSize(new Dimension(1, 1));
        jLabel42.setPreferredSize(new Dimension(200, 19));
        jLabel42.setRequestFocusEnabled(false);
        jLabel42.setVerifyInputWhenFocusTarget(false);
        jPanel_colorfulTextBar_filebrowser7.add(jLabel42, BorderLayout.CENTER);

        jPanel87.add(jPanel_colorfulTextBar_filebrowser7, BorderLayout.NORTH);

        jPanel75.add(jPanel87, BorderLayout.CENTER);

        jSplitPane5.setRightComponent(jPanel75);

        jPanel9.add(jSplitPane5, BorderLayout.CENTER);

        jPanel_EditorPanel.add(jPanel9, BorderLayout.CENTER);

        jPanel_MainFrame_Right.add(jPanel_EditorPanel);

        jPanel_comparator_container.setBackground(new Color(237, 237, 237));
        jPanel_comparator_container.setLayout(new BorderLayout());
        ...
        Editor.add(jCardcontainer_interactive, BorderLayout.CENTER);

        GUIContainer.add(Editor, "card6");

        jPanel_textPane.setBackground(new Color(237, 237, 237));
        jPanel_textPane.setBorder(BorderFactory.createLineBorder(new Color(
                200, 200, 200), 3));
        jPanel_textPane.setLayout(new BorderLayout());
        GUIContainer.add(jPanel_textPane, "card3");

        JPanel_PinsExtractor.setBackground(new Color(237, 237, 237));

        org.jdesktop.layout.GroupLayout JPanel_PinsExtractorLayout = new org.jdesktop.layout.GroupLayout(
                JPanel_PinsExtractor);
        JPanel_PinsExtractor.setLayout(JPanel_PinsExtractorLayout);
        JPanel_PinsExtractorLayout.setHorizontalGroup(JPanel_PinsExtractorLayout
                .createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(0, 1394,
                        Short.MAX_VALUE));
        JPanel_PinsExtractorLayout.setVerticalGroup(JPanel_PinsExtractorLayout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(0, 796, Short.MAX_VALUE));

        GUIContainer.add(JPanel_PinsExtractor, "card5");

        jPanel_Converter.setBackground(new Color(237, 237, 237));

        org.jdesktop.layout.GroupLayout jPanel_ConverterLayout = new org.jdesktop.layout.GroupLayout(
                jPanel_Converter);
        jPanel_Converter.setLayout(jPanel_ConverterLayout);
        jPanel_ConverterLayout.setHorizontalGroup(jPanel_ConverterLayout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(0, 1394, Short.MAX_VALUE));
        jPanel_ConverterLayout.setVerticalGroup(jPanel_ConverterLayout.createParallelGroup(
                org.jdesktop.layout.GroupLayout.LEADING).add(0, 796, Short.MAX_VALUE));
     ...
     */
    private void jButton_AddClinicalTextsActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_AddClinicalTextsActionPerformed
        ...
        if (flag == JFileChooser.APPROVE_OPTION) {
            ...
            if (selectedfiles.length > 0) {
                corpusImport.Copying cp = new corpusImport.Copying(this, selectedfiles,
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        ...
        // if row i has beed selected in the table, delete matched records in
        // these arraylist
        int i = size - 1;
        File currentfile = WorkSet.getCurrentFile();
    ...
    /*
     * public void insertDocument(String _text, Color _textColor, int _fontSize,
     * javax.swing.JTextPane _textPanel) {
     *
     * if (_text == null) return; if (_text.length() < 1) return;
     *
     * if (_textColor == null) _textColor = Color.black; if (_fontSize <= 1)
     * _fontSize = 12;
     *
     * try { SimpleAttributeSet set = new SimpleAttributeSet();
     * StyleConstants.setForeground(set, _textColor);
     * StyleConstants.setFontSize(set, _fontSize); Document doc =
     * _textPanel.getStyledDocument();
     *
     * doc.insertString(doc.getLength(), _text, set); } catch (Exception e) { }
     * }
     */
    ...
    private void jButton14ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton14ActionPerformed
        ...
        // new span
        try {
            // record when is the last time that user clicked next/previous
            // button
            // to go next or previous document
            env.Parameters.lastTimeToCallDocument = System.currentTimeMillis();
            ...
            // ##1##
            // exit from annotation comparison mode if editor panel and
            // comparator
            // panel are showed for comparing annotation conflits
            try {
                ((userInterface.annotationCompare.ExpandButton) jPanel60).setStatusInvisible();
            ...
            // System.out.println("2 set status to jpanel 60: "+ (point-
            // start));
            // start = point;
            ...
            disableAnnotationDisplay();
            // point= System.currentTimeMillis();
            // System.out.println("4 disable buttons and reset components: "+
            // (point- start));
            // start = point;
            ...
            log.LoggingToFile.log(Level.SEVERE, "\n==== ERROR ====::1106111233:: error got "
                    + "thrown out while navigate to next document" + ex.getLocalizedMessage());
        }
    ...
    private void jComboBox_InputFileListActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jComboBox_InputFileListActionPerformed
        ...
        // check the time interval between user's last clicking on the
        // previous/next
        // document,
     ...
     *
     * @return the annotation that is current selected in the list of "selected
     * annotations.
     */
    ...
    private void jToggleButton_CreateAnnotaionActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_CreateAnnotaionActionPerformed
    ...
    private void jToggleButton_ResultEditorActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_ResultEditorActionPerformed
     ...
     */
    private void jToggleButton_DictionarySettingActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_DictionarySettingActionPerformed
    ...
    /**
     * Show dialog to confirm exiting or not after user just has clicked exit
     * button on menu bar.
     */
    /**
     * user clicked button to active tab of pin extractor
     */
    private void jToggleButton_PinExtractorActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_PinExtractorActionPerformed
     ...
     */
    private void jToggleButton_DictionaryManagerActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_DictionaryManagerActionPerformed
        tabDoorman(TabGuard.tabs.dictionariesManager);
    }// GEN-LAST:event_jToggleButton_DictionaryManagerActionPerformed

    private void jToggleButton_exitActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_exitActionPerformed
        tabDoorman(TabGuard.tabs.exit);
    }// GEN-LAST:event_jToggleButton_exitActionPerformed

    private void jButton_spaneditor_deleteActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_spaneditor_deleteActionPerformed

        spanEdit(spanedittype.delete);
    }// GEN-LAST:event_jButton_spaneditor_deleteActionPerformed

    private void jButton_spaneditor_lefttToLeftActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_spaneditor_lefttToLeftActionPerformed
        // TODO add your process code here:
        spanEdit(spanedittype.headExtendtoLeft);
    }// GEN-LAST:event_jButton_spaneditor_lefttToLeftActionPerformed

    private void jButton4_spanEditor_rightToRightActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton4_spanEditor_rightToRightActionPerformed
        // TODO add your process code here:
        spanEdit(spanedittype.tailExtendtoRight);
    }// GEN-LAST:event_jButton4_spanEditor_rightToRightActionPerformed

    private void jButton_spaneditor_leftToRightActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_spaneditor_leftToRightActionPerformed
        spanEdit(spanedittype.headShortentoRight);
    }// GEN-LAST:event_jButton_spaneditor_leftToRightActionPerformed

    private void jTextField_searchtextKeyTyped(KeyEvent evt) {// GEN-FIRST:event_jTextField_searchtextKeyTyped
     ...
     */
    private void jButton_importAnnotationsActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_importAnnotationsActionPerformed
        if (settings == null)
            settings = new ImportSettings(this);
        settings.setVisible(true);
        /*
         * // import annotations from XML or PINS file // and then show on
         * screen(in result ediot) //importAnnotations();
         *
         *
         ...
         *
         * setNAVCurrentTab(3); /* //Run Verifier on input //Make sure verifier
         * dictionaries are loaded.
         * Dictionaries.VerifierDictionaries.loadPreAnnotatedConcepts(); for(int
         * i = 0; i< jComboBox_InputFileList.getItemCount(); i++ ) {
         * verifier.SpanCheck spanCheck = new verifier.SpanCheck(
         * env.ClinicalNoteList.SelectedTxtFile.getAbsoluteFileName(i),
         * env.Parameters.VERIFIER_DICTIONARIES); spanCheck.findProblems(-1); }
         */
    ...
    /**
     * This is a flag that used to indicated whether user clicked the button of
     * "continue" or button of "cancel" to remove all annotations.
     */
     ...
     */
    private void jButton_removeAllAnnotationsActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_removeAllAnnotationsActionPerformed
    ...
    {// GEN-HEADEREND:event_jButton12ActionPerformed
        ...
        // Display problem annotations to annotations... might not want to add
        // these directly to our memory
        // model. Probably better to just save them separately and append them
        // to the end of the written
        // XML file.
    ...
    private void jButton_SelectClassActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_SelectClassActionPerformed

        /**
         * while user click the icon of change annotation class on result
         * editor.
         * <p>
         * 1. show available annotation classnames for user to select while this
         * label is enabled.
         * <p>
         * 2. do nothing if this lable is disabled.
         * <p>
         */
        ...
        WorkSet.latestScrollBarValue = jScrollPane_textpane
                .getVerticalScrollBar().getValue();
        if (jButton_SelectClass.isEnabled()) {
            resultEditor.spanEdit.AnnotationClassChooser popmenu = new resultEditor.spanEdit.AnnotationClassChooser(
                    jTextField_annotationClassnames, this, jTextField_annotationClassnames
                    .getText().trim());
            popmenu.popupDialog(WorkSet.currentAnnotation.annotationText);
        } else {
    ...
    private void jButton_attributeActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_attributeActionPerformed

        setFlag_allowToAddSpan(WANT_NEW_SPAN); // cancel possible operation of
        // adding new span
    ...
    private void classesMouseClicked(MouseEvent evt)// GEN-FIRST:event_classesMouseClicked
    {// GEN-HEADEREND:event_classesMouseClicked
        setToClasses();
    }// GEN-LAST:event_classesMouseClicked

    private void classesMouseEntered(MouseEvent evt)// GEN-FIRST:event_classesMouseEntered
    ...
    private void annotationsMouseClicked(MouseEvent evt)// GEN-FIRST:event_annotationsMouseClicked
    {// GEN-HEADEREND:event_annotationsMouseClicked
        setToAnnotations();
    }// GEN-LAST:event_annotationsMouseClicked

    private void annotatorsMouseClicked(MouseEvent evt)// GEN-FIRST:event_annotatorsMouseClicked
    {// GEN-HEADEREND:event_annotatorsMouseClicked
        setToAnnotators();
    }// GEN-LAST:event_annotatorsMouseClicked

    /**
     * This will catch any events where a mouse is clicked on the infoList. If
     * left double click then the selction will be expanded if possible. If
     * right click in 'Conflicts' view then a pop up menu will come up to allow
     * you to resolve conflicts.
     *
     * @param evt - the mouse event
     */
    private void infoListMouseClicked(MouseEvent evt)// GEN-FIRST:event_infoListMouseClicked
    {// GEN-HEADEREND:event_infoListMouseClicked
        // If right click then do something... based on current screen.
        if (evt.getButton() == MouseEvent.BUTTON3) {
            switch (currentScreen) {
                // If we're dealing with ClassConflicts then allow the user to
                ...
                case ANNOTATIONS:
                case VERIFIER:
                    // resultEditor.PopUp.rightClickOnAnnotPopUp annotPopUp = new
                    // resultEditor.PopUp.rightClickOnAnnotPopUp(
                    // this.infoList, this);
                    // annotPopUp.pop((Annotation)infoList.getSelectedValue(),evt.getX(),
                    // evt.getY());
                    break;
            }
        }
        ...
        if (evt.getClickCount() == 2 && evt.getButton() == MouseEvent.BUTTON1) {
            ...
            switch (currentScreen) {
                // If A Class has been selected then show all Annotations with that
                // class
                case CLASSES:
                    ...
                    break;
                // If An annotator has been selected then show all Annotations with
                // that Annotator
                case ANNOTATORS:
                    selectAnAnnotator();
                    currentScreen = infoScreens.ANNOTATIONS;
                    break;
                // If A span conflict has been selected then show all Annotations
                // involved in that span conflict.
                case SPANCONFLICT:
    ...
    private void jTree_classMousePressed(MouseEvent evt) {// GEN-FIRST:event_jTree_classMousePressed

        // user just made a single click on the treeview of classes and
        // annotations
        WorkSet.mouse_clicked_on = 1;
    ...
    private void jTree_classTreeCollapsed(javax.swing.event.TreeExpansionEvent evt) {// GEN-FIRST:event_jTree_classTreeCollapsed
        resultEditor.annotationClasses.mouse.CollapsedListener collapsedlistener = new resultEditor.annotationClasses.mouse.CollapsedListener(
                evt, jTree_class);
    }// GEN-LAST:event_jTree_classTreeCollapsed

    /**
     * mouse events: mouse clicked on the text panel. They maybe want to select
     * an annotation; or build a complex relationship
     */
    ...
    private void verifierFlaggedMouseClicked(MouseEvent evt)// GEN-FIRST:event_verifierFlaggedMouseClicked
    {// GEN-HEADEREND:event_verifierFlaggedMouseClicked
        setToVerifier();
    }// GEN-LAST:event_verifierFlaggedMouseClicked

    private void verifierOnCurrentActionPerformed(ActionEvent evt)// GEN-FIRST:event_verifierOnCurrentActionPerformed
    ...
    private JLabel jLabel_cursor;
    private JLabel jLabel_icon_annotationlist;
    ...
    private JPanel jPanel8_bottomBar;
    private JPanel jPanel8_bottomBar1;
    private JPanel jPanel8_currentWorkSpace;
    private JPanel jPanel8_topBar;
    private JPanel jPanel8_topBar1;
    ...
    private JPanel jPanel_Converter;
    private JPanel jPanel_EditorPanel;
    private JPanel jPanel_MainFrame_Right;
    ...
    private JPanel jPanel_colorfulTextBar_filebrowser3;
    private JPanel jPanel_colorfulTextBar_filebrowser4;
    private JPanel jPanel_colorfulTextBar_filebrowser6;
    private JPanel jPanel_colorfulTextBar_filebrowser7;
    private JPanel jPanel_comparator_container;
    private JPanel jPanel_corpuslist_innerline;
    private JPanel jPanel_corpuslist_outline;
    private JPanel jPanel_infobar_center;
    private JPanel jPanel_infobar_right_current_annotator;
    private JPanel jPanel_interactive_left;
    private JPanel jPanel_leftSeparator;
    private JPanel jPanel_multipleResultShowList;
    ...
    private void infoListMouseMoved(MouseEvent evt)// GEN-FIRST:event_infoListMouseMoved
    {// GEN-HEADEREND:event_infoListMouseMoved
        // Make sure we're viewing Annotations(either Verifier or Annotations
        // Screen).
        if (currentScreen == infoScreens.ANNOTATIONS || currentScreen == infoScreens.VERIFIER) {
            ...
            if (infoList.getSelectedIndex() >= 0) {
                ...
                // Clear out tooltips if the current mouse movement is not over
                // the selected
                // item.
     ...
     */
    private void verifierOnAllActionPerformed(ActionEvent evt)// GEN-FIRST:event_verifierOnAllActionPerformed
     ...
     * @param evt
     */
    private void textPaneforClinicalNotesKeyPressed(KeyEvent evt)// GEN-FIRST:event_textPaneforClinicalNotesKeyPressed
    {// GEN-HEADEREND:event_textPaneforClinicalNotesKeyPressed
        WorkSet.mouse_clicked_on = 2;
        ;
        ...
        if (WorkSet.currentAnnotation != null) {
            ...
            if (evt.getKeyCode() == KeyEvent.VK_DELETE) {
                this.spanEdit(spanedittype.delete);
            }
            ...
            // Move the head of the span
                ...
                switch (evt.getKeyCode()) {
                    ...
                    case KeyEvent.VK_LEFT:
                    case KeyEvent.VK_UP:
                        if (GUI.reviewmode != ReviewMode.adjudicationMode)
                            moveToNextAnnotation(false);
                        else {
                            DiffCounter differenceCounter = new DiffCounter(
    ...
    private void jToggleButton_ConverterActionPerformed(ActionEvent evt)// GEN-FIRST:event_jToggleButton_ConverterActionPerformed
    ...
    private void jTree_classTreeExpanded(javax.swing.event.TreeExpansionEvent evt) {// GEN-FIRST:event_jTree_classTreeExpanded
        resultEditor.annotationClasses.mouse.NodeExpandedListener expanded = new resultEditor.annotationClasses.mouse.NodeExpandedListener(
                evt, jTree_class);
    }// GEN-LAST:event_jTree_classTreeExpanded

    private void jButton_crActionPerformed(ActionEvent evt)// GEN-FIRST:event_jButton_crActionPerformed
     ...
     *
     * @param evt Caught mouse event by system.
     */
    private void jTextField_annotatorMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jTextField_annotatorMouseClicked
    ...
    /**
     * While lost focus from this component which used to show annotator
     * information of current annotation, save changes and reset the component
     * to uneditable.
     */
    private void jTextField_annotatorFocusLost(FocusEvent evt) {// GEN-FIRST:event_jTextField_annotatorFocusLost
    ...
    /**
     * While user double clicked jTextArea_comment, set it editable for coming
     * modification to annotator comments of current annotation.
     * <p>
     * jTextArea_comment is a component of textarea used to show annotation
     * comments of current annotation.
     *
     * @param evt Caught mouse event by system.
     */
    private void jTextArea_commentMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jTextArea_commentMouseClicked
    ...
    /**
     * While lost focus from this component which used to show annotation
     * comments of current annotation, save changes and reset the component to
     * uneditable.
     */
    private void jTextArea_commentFocusLost(FocusEvent evt) {// GEN-FIRST:event_jTextArea_commentFocusLost
        setFlag_allowToAddSpan(false); // cancel possible operation of adding
        // new span
    ...
    private void jLabel_info_annotatorMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jLabel_info_annotatorMouseClicked
        if (evt.getClickCount() == 2)
            changeAnnotator();
    }// GEN-LAST:event_jLabel_info_annotatorMouseClicked

    private void jLabel_infobar_FlagOfOraclejLabel_info_annotatorMouseClicked(
            MouseEvent evt) {// GEN-FIRST:event_jLabel_infobar_FlagOfOraclejLabel_info_annotatorMouseClicked
    ...
    private void jLabel_infobar_FlagOfPathjLabel_info_annotatorMouseClicked(
            MouseEvent evt) {// GEN-FIRST:event_jLabel_infobar_FlagOfPathjLabel_info_annotatorMouseClicked
    ...
    private void jButton17ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton17ActionPerformed
        ...
        ((userInterface.annotationCompare.ExpandButton) jPanel60)
                .acceptreject_acceptPrimaryAnnotation();

        // adjudication.statusBar.DiffCounter diffcounter = new
        // adjudication.statusBar.DiffCounter(this.jLabel23,
        // WorkSet.getCurrentFile().getName(), this);
    ...
    private void jButton24ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton24ActionPerformed
        ...
        ((userInterface.annotationCompare.ExpandButton) jPanel60)
                .acceptreject_rejectPrimaryAnnotation();
        // adjudication.statusBar.DiffCounter diffcounter = new
        // adjudication.statusBar.DiffCounter(this.jLabel23,
        // WorkSet.getCurrentFile().getName(), this);
        // diffcounter.accepted( );
    ...
    private void jButton_span_rightToLeftActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_span_rightToLeftActionPerformed
        // ((userInterface.annotationCompare.ExpandButton)
        // jPanel60).acceptreject_ignorePrimaryAnnotation();
        spanEdit(spanedittype.tailshortentoLeft);
    }// GEN-LAST:event_jButton_span_rightToLeftActionPerformed

    private void jList_complexrelationshipsMouseClicked(MouseEvent evt)// GEN-FIRST:event_jList_complexrelationshipsMouseClicked
    ...
    private void jButton_removeduplicatesActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_removeduplicatesActionPerformed
        ...
        resultEditor.annotations.opt.GhostAndDuplicatesSeeker rd = new resultEditor.annotations.opt.GhostAndDuplicatesSeeker(
                this);
        rd.setVisible(true);
    ...
    /**
     * This will pop up a dialog to let you input a new path to open as
     * workspace.
     */
    public void dialog_toInputNewWorkspacePath() {
        ...
        workSpace.SetWorkSpace setWS = new workSpace.SetWorkSpace(this, "call_from_Nav", location,
                size);
     ...
     * pane;
     */
    private void jList_NAV_projectsMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jList_NAV_projectsMouseClicked
    ...
    public void config_saveProjectSetting() {
        ...
        // save configure setting for current project
        config.project.ProjectConf projectconf = new config.project.ProjectConf(currentproject);

        projectconf.saveConfigure();

    }

    private void jButton_save1ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_save1ActionPerformed
    ...
    private void jLabel22MouseReleased(MouseEvent evt)// GEN-FIRST:event_jLabel22MouseReleased
    ...
    private void jList_corpusMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jList_corpusMouseClicked
    ...
    private void jButton_AddClinicalTexts1ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_AddClinicalTexts1ActionPerformed
    ...
    /**
     * user can select a recently used workspace in the combo list and EHOST
     * should bring user into this folder.
     */
    private void jComboBox_currentworkspace_abspathItemStateChanged(ItemEvent evt) {// GEN-FIRST:event_jComboBox_currentworkspace_abspathItemStateChanged

        // this function only works after EHOST system had initialized.
        if (jComboBox_currentworkspace_abspath.getItemCount() != workSpace.switcher.RecentWorkSpace
                .getItemCount())
            return;
    ...
    /**
     * There is a combo list on the navigator panel, which can show you recently
     * used workspace. This method is to make sure current workspace is
     * currently displayed.
     */
    ...
    private void delete_RelationshipsActionPerformed(ActionEvent evt) {// GEN-FIRST:event_delete_RelationshipsActionPerformed
        try {
            ListEntryofRelationship toDelete = (ListEntryofRelationship) this.jList_complexrelationships
                    .getSelectedValue();
            if (toDelete != null) {
    ...
    private void jRadioButton_treeview_overallActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jRadioButton_treeview_overallActionPerformed
        display_showCategories();
    }// GEN-LAST:event_jRadioButton_treeview_overallActionPerformed

    private void jRadioButton_treeview_currentarticleActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jRadioButton_treeview_currentarticleActionPerformed
        display_showCategories();
    ...
    private void jToggleButton_sequence_inCharactersActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_sequence_inCharactersActionPerformed
        changeDisplaySequence_toAnnotationUniques();
    }// GEN-LAST:event_jToggleButton_sequence_inCharactersActionPerformed

    private void jToggleButton_sequence_inLocationActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_sequence_inLocationActionPerformed
        changeDisplaySequence_toAnnotationUniques();
     ...
     * <p>
     * Tested for : import external schema XML files which was pull out from the
     * server side.
     */
    private void jLabel_infobarMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jLabel_infobarMouseClicked
        ...
        // get the access to the external XML file which we need to
        // convert/extract
        // File externalSchemaFile = new
        // File("/Users/leng/Downloads/schema (1).xml");
        ...
        // webservices.InitProject init = new webservices.InitProject( new
        // File("/Users/leng/"), externalSchemaFile );

        // webservices.utils.SchemaConvertor schemaConvertor = new
        // webservices.utils.SchemaConvertor();
        ...
        // webservices.utils.Project.initProject("/Users/leng/Downloads/22",
        // "/Users/leng/Downloads/schema (2).xml");
    ...
    private void jLabel_infobar_attributeEditorMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jLabel_infobar_attributeEditorMouseClicked
    ...
    private void jToggleButton_AssignmentScreenActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jToggleButton_AssignmentScreenActionPerformed
        tabDoorman(TabGuard.tabs.assignmentsScreen);
    }// GEN-LAST:event_jToggleButton_AssignmentScreenActionPerformed

    private void jLabel_infobar_FlagOfDiffMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jLabel_infobar_FlagOfDiffMouseClicked
        ...
        // user define what's the difference they want.
            ...
            final ActionListener menuListener = new ActionListener() {
                ...
                public void actionPerformed(ActionEvent event) {
                    userInterface.differenceMatching.DefineDialog customdlg = new userInterface.differenceMatching.DefineDialog(
                            GUI.this);
    ...
    private void jRadioButton_adjudicationModeMouseReleased(MouseEvent evt) {// GEN-FIRST:event_jRadioButton_adjudicationModeMouseReleased
    ...
    /**
     * user want to active the annotation mode by clicking the radio button of
     * annotation mode;
     */
    private void jRadioButton_annotationModeMouseReleased(MouseEvent evt) {// GEN-FIRST:event_jRadioButton_annotationModeMouseReleased
     ...
     *
     * @param isForceUpdate Flag that tell method whether need to update all information
     *                      on screen no matter current mode is already in annotation
     *                      mode.
     */
    public void mode_enterAnnotationMode(boolean isForceUpdate) {
        ...
        if (isForceUpdate) {
            this.reviewmode = ReviewMode.ANNOTATION_MODE;
        }
        // do only while
    ...
    private void jList_normalrelationshipMouseClicked(MouseEvent evt) {// GEN-FIRST:event_jList_normalrelationshipMouseClicked
        // TODO add your handling code here:
    ...
    private void jList_SpansValueChanged(javax.swing.event.ListSelectionEvent evt) {// GEN-FIRST:event_jList_SpansValueChanged
        ...
        /*
         * if(((userInterface.annotationCompare.ExpandButton)jPanel60).
         * isDiffPanelWorking){ jButton10.setEnabled(false);
         * jButton3.setEnabled(false); return; }
         */
    ...
    private void addSpan(MouseEvent evt, boolean requiringFromButton) {
        try {
            ...
            log.LoggingToFile.log(Level.SEVERE,
                    "1202161233::fail to create new span." + ex.getLocalizedMessage());
        }
    }

    private void jButton_SpanAddActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_SpanAddActionPerformed

        addSpan(null, true);

    }// GEN-LAST:event_jButton_SpanAddActionPerformed

    private void jButton_SpanRemoveActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_SpanRemoveActionPerformed
        setFlag_allowToAddSpan(false); // cancel possible operation of adding
        // new span
        jButton_SpanRemove.setEnabled(false);
    ...
    private void jTree_classTreeWillCollapse(javax.swing.event.TreeExpansionEvent evt)
            throws javax.swing.tree.ExpandVetoException {// GEN-FIRST:event_jTree_classTreeWillCollapse
        resultEditor.annotationClasses.mouse.CollapsedListener collapsedlistener = new resultEditor.annotationClasses.mouse.CollapsedListener(
                evt, jTree_class);
    }// GEN-LAST:event_jTree_classTreeWillCollapse

    private void ToolBarMouseReleased(MouseEvent evt) {// GEN-FIRST:event_ToolBarMouseReleased
        showAnnotationCategoriesInTreeView_refresh(); // TODO add your handling
        // code here:
    }// GEN-LAST:event_ToolBarMouseReleased

    private void jPanel_NAV_Card3MousePressed(MouseEvent evt) {// GEN-FIRST:event_jPanel_NAV_Card3MousePressed

    }// GEN-LAST:event_jPanel_NAV_Card3MousePressed

    private void jToolBar6MouseMoved(MouseEvent evt) {// GEN-FIRST:event_jToolBar6MouseMoved
        // TODO add your handling code here:
     ...
     */
    private void jLabel25MouseClicked(MouseEvent evt) {// GEN-FIRST:event_jLabel25MouseClicked

        /*
         * if( dictManager != null ){ dictManager.toFront();
         * dictManager.setVisible( true ); }else{ dictManager = new
         * bobDict.DictManager( this ); dictManager.setVisible( true ); }
         */
    ...
    private void jButton_importAnnotations1ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_importAnnotations1ActionPerformed
        if (console == null)
            console = new nlp.tableExtraction.Monitor(this);
        console.setVisible(true);
    }// GEN-LAST:event_jButton_importAnnotations1ActionPerformed

    private void jButton_relationshipsActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton_relationshipsActionPerformed
        // this.WANT_NEW_SPAN = false; // cancel possible operation of adding
        // new span
        setFlag_allowToAddSpan(false);
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (isFirstValidRecord) {
                    annotationText = textPaneforClinicalNotes.getText(span.start, span.end
                            - span.start);
            ...
            log.LoggingToFile.log(Level.SEVERE,
                    "1202151405::fail to get all span texts" + ex.getLocalizedMessage());
            return null;
        }
    }
    ...
    private void changeDisplaySequence_toAnnotationUniques() {
        ...
        // check the button
        env.Parameters.ShowAnnotationUniquesInTree.isLocationSequence = !jToggleButton_sequence_inCharacters
                .isSelected();
    ...
    private void deleteProject() {
        ...
        workSpace.DeleteProject delProject = new workSpace.DeleteProject(this, jList_NAV_projects,
                location, size);
    ...
    public void setFlag_of_OracleSimilarPhraseSeeker(boolean isEnabled) {
        try {
            ...
            if (isEnabled) {
                ...
                jLabel_infobar_FlagOfOracle
                        .setToolTipText("Oracle Dialog Enabled to find similar annotations.");
            } else {
            ...
            log.LoggingToFile.log(Level.SEVERE,
                    "error 1010111612:: fail to set status and icon to indicate oracle ");
        }
    }
    ...
    // }catch(Exception ex){
    // log.LoggingToFile.log( Level.SEVERE,
    // "error 1010111612:: fail to set status and icon to graph path ");
    // }
    // }
    ...
    public void highlightAnnotations(String annotationText) {
        ...
        File currentTextSource = WorkSet.getCurrentFile();
        Depot depot = new Depot();
        Article article = depot.getArticleByFilename(currentTextSource
                .getName());
        if (article == null)
            return;
     ...
     *
     * @param textfiles List of files we want to add into current list of text
     *                  sources.
     */
    ...
    /**
     * Add just one text source files into memory. Before adding, check
     * repetitive and only add file who is new to current text source list.
     *
     * @param textfile The text file we want to add into current list of text
     *                 sources.
     */
     ...
     *
     * @param textinfo The text string you want to show on the bar at the bottom of
     *                 the GUI.
     */
    ...
    public void updateScreen_for_variables() {
        try {
            ...
            resultEditor.annotator.Manager annotatormanager = new resultEditor.annotator.Manager(
                    this.jLabel_info_annotator);
...
//                    + env.Parameters.enabled_Diff_Display);
    ...
    public void display_setCarpetOn(int position) {
        try {
            ...
            Rectangle rect = this.textPaneforClinicalNotes.getUI().modelToView(
                    this.textPaneforClinicalNotes, position);
    ...
    public void showDifferentMatching() {
        try {
            ...
            File curr_f = WorkSet.getCurrentFile();
     ...
     * to set the borders of corresponding components. Use red rectangles to
     * indicate difference.
     * <p>
    ...
    public void display_setRedRectangle_toMarkDifferences(
        ...
        try {
            if ((isDifference_inSpan) && (env.Parameters.DifferenceMatching.checkatt_forSpan)) {
                jScrollPane_Spans.setBorder(BorderFactory.createLineBorder(
                        new Color(255, 0, 0), 2));
            } else {
            ...
            log.LoggingToFile.log(Level.SEVERE, "error 1011162346::21");
        }
        ...
        try {
            if ((isDifference_inClass) && (env.Parameters.DifferenceMatching.checkatt_forClass)) {
                jTextField_annotationClassnames.setBorder(BorderFactory
                        .createLineBorder(new Color(255, 0, 0), 2));
            } else {
                jTextField_annotationClassnames.setBorder(STANDARD_TEXTFIELD_BOARD);
            }
        } catch (Exception ex) {
            log.LoggingToFile.log(Level.SEVERE, "error 1011162346::23");
        }

        // ##4## set boarder if difference found in annotation comments
        /*
         * try{ if
         * ((isDifference_inComment)&&(env.Parameters.DifferenceMatching.
         * checkatt_forComment)){
         * jPanel66.setBorder(javax.swing.BorderFactory.createLineBorder(new
         * java.awt.Color(255, 0, 0), 2)); }else{ jPanel66.setBorder(null); }
         * }catch(Exception ex){log.LoggingToFile.log( Level.SEVERE,
         * "error 1011162346::24");}
         */

        // ##5## set boarder if difference found in annotator of annotations
        try {
            if ((isDifference_inAnnotator)
                    && (env.Parameters.DifferenceMatching.checkatt_forAnnotator)) {
                jTextField_annotator.setBorder(BorderFactory.createLineBorder(
                        new Color(255, 0, 0), 2));
            } else {
                jTextField_annotator.setBorder(STANDARD_TEXTFIELD_BOARD);
            }
        } catch (Exception ex) {
            log.LoggingToFile.log(Level.SEVERE, "error 1011162346::25");
        }

        // ##6## set boarder if difference found in complex relationships of
        // annotations
        try {
            if ((isDifference_inComplexRelationship)
                    && (env.Parameters.DifferenceMatching.checkatt_forComplex)) {
                jPanel70.setBorder(BorderFactory.createLineBorder(new Color(
                        255, 0, 0), 2));
            } else {
                jPanel70.setBorder(null);
            }
        } catch (Exception ex) {
            log.LoggingToFile.log(Level.SEVERE, "error 1011162346::26");
        }

        // ##7## set boarder if difference found in normal relationships of
        // annotations
        try {
            if ((isDifference_inNormalRelationship)
                    && (env.Parameters.DifferenceMatching.checkatt_forNormal)) {
                jPanel71.setBorder(BorderFactory.createLineBorder(new Color(
                        255, 0, 0), 2));
            } else {
                jPanel71.setBorder(null);
            }
        } catch (Exception ex) {
            log.LoggingToFile.log(Level.SEVERE, "error 1011162346::27");
        }
     ...
     * <p>
     * It will be called from class
     * "userInterface.annotationCompare.ExpandButton.java"
     */
    ...
    /**
     * Allow modification operation after eHOST leaving the mode of comparing
    ...
    public void showAnnotationCategoriesInTreeView_refresh() {
        ...
        resultEditor.annotationClasses.navigationTree.UpDateNavigationPanel sct = new resultEditor.annotationClasses.navigationTree.UpDateNavigationPanel(
                jTree_class, this);

        if (WorkSet.getCurrentFile() == null) {
            log.LoggingToFile.log(Level.SEVERE,
                    "### ERROR ### 1106091630:: fail to get current filename");
    ...
    public void showAnnotationCategoriesInTreeView_CurrentArticle() {
        ...
        if (WorkSet.getCurrentFile() == null) {
            ...
            sct.display();
            log.LoggingToFile.log(Level.SEVERE,
                    "### ERROR ### 1106091631:: fail to get current filename");
            return;
        }
    ...
    public void showAnnotationCategoriesInTreeView_selectCategory(String category,
     ...
     *
     * // clean the table ((DefaultTableModel)
     * jTable_SelectedClinicalFiles.getModel
     * ()).getDataVector().removeAllElements(); ((DefaultTableModel)
     * jTable_SelectedClinicalFiles.getModel()).fireTableDataChanged();
     *
     * // show in the table for (int i = 0; i <
     * env.Parameters.LIST_ClinicalNotes.size(); i++) { Object[] row = {
     ...
     * jLabel_filecollection.setText(" >FILE COLLECTION (" +
     * env.Parameters.LIST_ClinicalNotes.size()+")");
     *
    ...
    /**
     * This funcation only can be called by dialogs.exit after you had click the
     * yes or no button. If answer is "yes", then close the whole application;
     * O.W, do nothing.
     */
     ...
     * reminder user whether they really want to exit. Clicking on the "exit"
     * button leads to shut down the whole eHOST system.
     */
    public void popupExitDialog() {
        ...
        // modal window, so all threads will be stopped until this dialog got
        // closed.
    ...
    /**
     * empty all attributes/text field in result editor, which maybe got used in
     * pervious operation
     */
    ...
    private void showAnnotatorsOfAllSelectedAnnotations() {
        Vector<Integer> selectedAnnotationIndexes = Depot.SelectedAnnotationSet
        ...
        for (int i = 0; i < size; i++) {
            ...
            Annotation annotation1 = depot.getAnnotationByUnique(
                    textsourcefilename, uniqueindex);
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int j = i + 1; j < size; j++) {
                    ...
                    Annotation annotation2 = depot.getAnnotationByUnique(
                            textsourcefilename, uniqueindex2);
                    if (annotation2 == null || !annotation2.visible)
                        continue;

                    boolean samespan = report.iaaReport.analysis.detailsNonMatches.Comparator
                            .equalSpans(annotation1, annotation2);
                    if (!samespan)
                        return false;
                    boolean sameclass = report.iaaReport.analysis.detailsNonMatches.Comparator
                            .equalClasses(annotation1, annotation2);
                    if (!sameclass)
                        return false;
                    boolean sameatt = report.iaaReport.analysis.detailsNonMatches.Comparator
                            .equalAttributes(annotation1, annotation2);
                    if (!sameatt)
                        return false;
            ...
            log.LoggingToFile.log(Level.SEVERE,
                    "1109280007::fail to compare multiple selected annotaitons!");
        }
     ...
     * annotaion's details on related field. You you left clicked mouse on a
     * position of a text source. You may select one or more annotaions who span
     * cover the point you just clicked;
     *
     * @param initializeIndex Index of annotations marked as preselected in the list. This
     *                        annotation will be highlighted by colorful under line.
     */
    public void showSelectedAnnotations_inList(int initializeIndex) {

        resultEditor.selectedAnnotationView.AnnotationListScreen list = new resultEditor.selectedAnnotationView.AnnotationListScreen(
                this, this.jList_selectedAnnotations, this.jLabel_icon_annotationlist.getIcon());
    ...
    public void display_annotation_inListOnEditorPanel(int uniqueindex) {
        ...
        list.showAnnotations_withSpecificUniqueindex(uniqueindex);
        Annotation ann = depot.getAnnotationByUnique(WorkSet.getCurrentFile().getName(),
                uniqueindex);
        if (ann != null)
    ...
    public void display_repaintHighlighter() {
        ...
        resultEditor.display.Screen screen = new resultEditor.display.Screen(
                textPaneforClinicalNotes, WorkSet.getCurrentFile());
     ...
     * reject annotations; It only show one annotation from the selected
     * annotation set; Other annotation will be show on the comparator panel as
     * alternative items. This function is very similar to method
     * "showSelectedAnnotations_inList";
     *
     * @param uniqueindex
     */
    ...
    private void listSpans(JList list, Annotation ann) {
        ...
        try {
            ...
            Vector<userInterface.structure.SpanObj> entries = new Vector<userInterface.structure.SpanObj>();
            ...
            for (int i = 0; i < ann.spanset.size(); i++) {
                ...
                userInterface.structure.SpanObj spanObj = new userInterface.structure.SpanObj(ann,
                        span, icon_span);
                entries.add(spanObj);
            }
    ...
    public String getText(int start, int end) {
        ...
        try {
            ...
            log.LoggingToFile.log(Level.SEVERE,
                    "can't get designated span text from current document viewer!");
            return null;
        }
    ...
    public void display_showAnnotationDetail_onEditorPanel(
        ...
        if (annotation == null) {
            ...
            WorkSet.currentAnnotation = annotation;
            ...
            showAnnotationCategoriesInTreeView_selectCategory(annotation.annotationclass,
                    annotation.annotationText);

            if ((annotation.adjudicationStatus == Annotation.AdjudicationStatus.MATCHES_OK)
                    && (GUI.reviewmode == ReviewMode.adjudicationMode)) {
            ...
            Depot depot = new Depot();
            Vector<Integer> selectedAnnotationUniqueindexes = Depot.SelectedAnnotationSet
                    .getSelectedAnnotationSet();
             ...
             * selectedAnnotationUniqueindexes.get(i);
             * resultEditor.annotations.Annotation anAnnotation =
             * depot.getAnnotationByUnique( textsourcefilename, index ); for
             * (suggestion suggest : anAnnotation.verifierFound) { if
             * (!explanations.contains(suggest.getExplanation()))
             * explanations.add(suggest.getExplanation()); else if
             * (!suggested.contains(suggest)) suggested.add(suggest); } }
             */
    ...
    /**
     * if suggestions of a annotation is not empty, show contents and highlight
     * the rectangle in red lines.
     */
    ...
    public void display_markPhrase(Annotation annot) {
        ...
        // int offset =
        // ResultEditor.Conflicts.ConflictButtonPainter.getScreenOffset(start,
        // 1);
        // jLabel1.setText("offset = "+ offset);

        // highlight manger
        final resultEditor.underlinePainting.SelectionHighlighter hightlighter = new resultEditor.underlinePainting.SelectionHighlighter(
                textPaneforClinicalNotes);
    ...
    public void goUserDesignated(String filename) {
        ...
        log.LoggingToFile.log(Level.SEVERE,
                "1008190444 - fail to find index of designated text source.");
    }
    ...
    public void addPositionIndicator() {
        resultEditor.positionIndicator.Display assemble = new resultEditor.positionIndicator.Display(
                this, this.jPanel_position_indicator_container);
    }

    /**
     * indicate the position indicator
     */
    public void setPositionIndicator(
            resultEditor.positionIndicator.JPositionIndicator positionindicator) {
    ...
    public void showValidPositionIndicators() {
        ...
        try {
            if (jTabbedPane3.getSelectedIndex() == 0) {
                File file = WorkSet.getCurrentFile();

                // System.out.println(
                // "current show position indicators for file:[" +
                // file.getName().trim() + "]" );
            ...
            log.LoggingToFile.log(Level.SEVERE,
                    "error 1103141511:: fail to show valid postion indicators" + ex.getMessage());
        }
    }
    ...
    /**
     * This method will call Workspace.Switcher.RecentWOrkspac to record recent
     * used workspace;
     */
    ...
    public void componentPostProcessing() {
        ...
        try {
            ...
            ((userInterface.annotationCompare.ExpandButton) jPanel60).setContainerPart(
                    this.jPanel_comparator_container, jButton_spaneditor_delete, jSeparator2,
                    // jLabel8,
                    jToolBar_editopanel_comparison,
                    // list for displaying selected annotations in editor panel
                    jList_selectedAnnotations, this, textPaneforClinicalNotes);

            // After all component(no null) have been imported into this
            // expandable
    ...
    public void changeAnnotationToSuggestion(Annotation toChange, suggestion theRightOne) {
         ...
         * DISDISDIS
         *
         * boolean refreshScreen = false; //Used to send to span editor. int
         * delete = 0, headdecrease = 1, tailincrease = 2, headincrease = 3,
         * taildecrease = 4; if (theRightOne != null) { // get current span and
         * annotation Object[] selectedObjs =
         * this.jList_Spans.getSelectedValues(); if( selectedObjs == null )
         * return; userInterface.structure.SpanObj spanobj = null; try{ spanobj
         * = (userInterface.structure.SpanObj) selectedObjs[0]; }catch(Exception
         * ex){ spanobj= null; } if(spanobj==null) return; Annotation annotation
         * = spanobj.getAnnotation(); SpanDef span = spanobj.getSpan();
         * //Extract the difference between the start spans and end spans of the
         * suggested and current. int headChange = toChange.spanstart -
         * theRightOne.getStart(); int endChange = toChange.spanend -
         * theRightOne.getEnd(); //If the original head is greater than the
         * suggested then shift left. if(headChange > 0) { //Keep shifting until
         * we have shifted to the suggested position. for (int shifts = 0;
         * shifts < headChange ; shifts++) { resultEditor.spanEdit.SpanEditor
         * spanEditor = new resultEditor.spanEdit.SpanEditor(annotation, span,
         * textPaneforClinicalNotes); if
         * (spanEditor.editCurrentDisplayedSpan(headdecrease) > 0) {
         * refreshScreen = true; } } } //If the original head is less than the
         * suggested head then shift right. else if(headChange < 0) { //Keep
         * shifting unil we have reached the suggested position. for (int shifts
         * = 0; shifts < Math.abs(headChange) ; shifts++) {
         * resultEditor.spanEdit.SpanEditor spanEditor = new
         * resultEditor.spanEdit.SpanEditor(annotation, span,
         * textPaneforClinicalNotes); if
         * (spanEditor.editCurrentDisplayedSpan(headincrease) > 0) {
         * refreshScreen = true; } } } //If the original end is greater than the
         * suggested end, shift left. if(endChange > 0) { //Shift until we reach
         * the suggested position. for (int shifts = 0; shifts < endChange ;
         * shifts++) { resultEditor.spanEdit.SpanEditor spanEditor = new
         * resultEditor.spanEdit.SpanEditor(annotation, span,
         * textPaneforClinicalNotes); if
         * (spanEditor.editCurrentDisplayedSpan(taildecrease) > 0) {
         * refreshScreen = true; } } } //If the original end is less than the
         * suggested end, shift right. else if(endChange<0) { //Keep shifting
         * until we reach the suggested position. for (int i = 0; i <
         * Math.abs(endChange) ; i++) { resultEditor.spanEdit.SpanEditor
         * spanEditor = new resultEditor.spanEdit.SpanEditor(annotation, span,
         * textPaneforClinicalNotes); if
         * (spanEditor.editCurrentDisplayedSpan(tailincrease) > 0) {
         * refreshScreen = true; } } } } if (refreshScreen) { //Get the new
         * verifier result for this annotation.
         * checkOneVerifier(WorkSet.indexOfCurrentAnnotation);
         *
         * disableAnnotationDisplay(); this.repaintHighlighter();
         * showSelectedAnnotations_inList
         * (env.Parameters.latestSelectedInListOfMultipleAnnotions);
         *
         * }
         */
    ...
    public enum spanedittype {
        headExtendtoLeft, headShortentoRight, tailExtendtoRight, tailshortentoLeft, delete
    }
    ...
    public void spanEdit(spanedittype _type) {
        ...
        resultEditor.spanEdit.SpanEditor spanEditor = new resultEditor.spanEdit.SpanEditor(
                annotation, span, textPaneforClinicalNotes);

        // define indicators
        int delete = 0, headdecrease = 1, tailincrease = 2, headincrease = 3, taildecrease = 4;
        ...
        if (GUI.reviewmode == ReviewMode.ANNOTATION_MODE) {
            try {
                ...
                if (_type != spanedittype.delete) {
                    ...
                    // disable buttons if just deleted an annotations by the
                    // button
                    jButton_SelectClass.setEnabled(false);
                    showAnnotationCategoriesInTreeView_refresh();
                    showValidPositionIndicators();
                ...
                log.LoggingToFile.log(Level.SEVERE,
                        "error 1012011438:: fail to refresh screen after " + "span modified!!!");
            }

            // backtoPreviousFocusPoint();

        } else if (GUI.reviewmode == ReviewMode.adjudicationMode) {
            // if a span is changed in adjudication mode

            Vector<Integer> selectedAnnotation = Depot.SelectedAnnotationSet
                    .getSelectedAnnotationSet();
            int uniqueindex = -1;
    ...
    /**
     * refresh after modification made on annotation among several selected
     * annotations
     */
    public void refresh() {
        refresh(null);
    ...
    private void refresh(spanedittype is_an_span_deleted) {
        // to current modifying annotation, get the its idnex in the annotation
        // list
        ...
        if ((is_an_span_deleted == null) || (is_an_span_deleted != spanedittype.delete)) {
            ...
            // ##1## if is in mode of annotation comparing, this function will
            // be disabled
            if (((userInterface.annotationCompare.ExpandButton) jPanel60)
                    .isComparatorPanelExpanded()) {

                display_showOneAnnotation_inListOnEditorPanel(WorkSet.currentAnnotation.uniqueIndex);
    ...
    /**
     * call class to start process of saving annotations and its attributes into
     * xml or pins files.
     */
    ...
    /**
     * This method will change the selected annotation to whichever suggestion
     * is currently selected in the suggestions jList.
     */
    private void changeSelectedToSuggestion() {
        // int latestScrollBarValue =
        // jScrollPane_textpane.getVerticalScrollBar().getValue();
        Annotation toChange = WorkSet.currentAnnotation;
    ...
    /**
     * This method will check a single annotation for potential problems using
     * the verifier.
     *
     * @param originalArrayIndex - The Array Index of the annotation in the static storage
     *                           space.
    ...
    private void checkOneVerifier(int originalArrayIndex) {
        /*
         * verifier.SpanCheck spanCheck = new verifier.SpanCheck(
         * env.clinicalNoteList
         * .CorpusLib.getAbsoluteFileName(jComboBox_InputFileList
         * .getSelectedIndex()), env.Parameters.VERIFIER_DICTIONARIES);
    ...
    public void show_dialog_of_preference_to_manage_dictionaries() {
        ...
        // show the dialog(frame) of preference to modify pre-annoated concept
        // dictinaries
     ...
     *
     * @param selectedIndex_inList the index of select items in the jlist of selected annotations
     */
    private void showDetailsByIndex(int selectedIndex_inList) {
        ...
        try {
            ...
            String currentTextSource = WorkSet.getCurrentFile().getName();

            // get indexes of selected annotations in the article in the depot
            Depot depot = new Depot();
            Vector<Integer> selectedannotations = Depot.SelectedAnnotationSet
                    .getSelectedAnnotationSet();
            ...
            Annotation annotation = depot.getAnnotationByUnique(
                    currentTextSource, selectedannotations.get(selectedIndex_inList));
            // record to indicate current annotation and its index in the artile
            // in the depot
            WorkSet.currentAnnotation = annotation;
            WorkSet.indexOfCurrentAnnotation = selectedannotations
                    .get(selectedIndex_inList);
            ...
            // echo for debug
            // System.out.println("User clicked on annotation: Adjudication=" +
            // annotation.adjudicationStatus + " id="+annotation.uniqueIndex);
            ...
            if ((annotation.adjudicationStatus == Annotation.AdjudicationStatus.MATCHES_OK)
                ...
                jTextField_annotator.setText("ADJUDICATION");
                jTextField_annotator.setBorder(STANDARD_TEXTFIELD_BOARD);
            } else if ((annotation.getFullAnnotator() != null)
                    && (annotation.getFullAnnotator().trim().length() > 0)) {
            ...
            // MUSTMUST111017setVerifierSuggestion(
     ...
     * one annotation in the annotation list on the document viewer gui.
     *
     * @param _annotation a given annotation, and we want to show
     */
    private void showDetails(Annotation _annotation) {
        ...
        try {
            ...
            showAnnotationCategoriesInTreeView_selectCategory(_annotation.annotationclass,
            ...
            if ((_annotation.adjudicationStatus == Annotation.AdjudicationStatus.MATCHES_OK)
                ...
                jTextField_annotator.setText("ADJUDICATION");
                jTextField_annotator.setBorder(STANDARD_TEXTFIELD_BOARD);
            } else if ((_annotation.getFullAnnotator() != null)
                    && (_annotation.getFullAnnotator().trim().length() > 0)) {
            ...
            if ((_annotation.creationDate != null)
                    && (_annotation.creationDate.trim().length() > 0)) {
    ...
    /**
     * Call this when a mouse click occurs on the Jlist. Invert 'selected'
     * variable for the selected iListEntry.
     *
    ...
    private void mouseClicked_onList(JList thislist) {
        ...
        for (int i = 0; i < size; i++) {
            ListEntryofRelationship otherTerm = (ListEntryofRelationship) thislist.getModel()
                    .getElementAt(i);
    ...
    public void setFlag_allowToAddSpan(boolean allowed) {
        this.WANT_NEW_SPAN = allowed; // cancel possible operation of adding new
        // span
        if (allowed)
    ...
    private void setDialogPosition() {
        ...
        /*
         * // **** setting the location of gui window Dimension winSize =
         * Toolkit.getDefaultToolkit().getScreenSize(); int screenWidth =
         * winSize.width; int screenHeight = winSize.height; // if screen have
         * enough space for this window, show it within its prefect size //
         * otherwise, use the maxsize of the display device if ((screenWidth >=
         * perfectWidth) && (screenHeight >= perfectHeight)) { int x = (int)
         * (screenWidth - perfectWidth) / 2; int y = (int) (screenHeight -
         * perfectHeight) / 2; this.setSize(perfectWidth, perfectHeight);
         * this.setLocation(x, y); } else { this.setSize(screenWidth,
         * screenHeight); this.setLocation(0, 0); }
         */
     ...
     * component of textfield which used to show annotator information lost its
     * focus.
     */
    private void saveChanges_on_Annotator() {
        ...
        try {
            ...
            log.LoggingToFile
                    .log(Level.SEVERE,
                            "Error 1009231634 : fail to get current while try to save changes of annotator!");
        }

        // validity check
        if ((annotation == null) || (!(annotation instanceof Annotation))) {
            log.LoggingToFile
                    .log(Level.SEVERE,
                            "Error 1009231636 : fail to get current while try to save changes of annotator!");
            return;
        }
        ...
        try {
            ...
            log.LoggingToFile.log(Level.SEVERE,
                    "Error 1009231637 : fail to to save changes of annotator!");
            return;
        }
    ...
    /**
     * Save changes of comment to current annotation while component of
     * textfield which used to show annotator information lost its focus.
     */
    private void saveChanges_on_Comments() {
        ...
        if ((annotation == null) || (!(annotation instanceof Annotation))) {
            log.LoggingToFile
                    .log(Level.SEVERE,
                            "Error 1009231711 : fail to get current while try to save changes of comments!");
            return;
        }
        ...
        try {
            ...
            log.LoggingToFile.log(Level.SEVERE,
                    "Error 1009231712 : fail to to save changes of comment!");
            return;
        }
    ...
    /**
     * add drop event handing process to list of text source, whose type is
     * JTable.
     */
    ...
    private void changeAnnotator() {
        try {
            resultEditor.annotator.ChangeAnnotator changeannotator = new resultEditor.annotator.ChangeAnnotator(
                    this, null);
    ...
    public void display_showSymbolIndicators() {
        try {
            ...
            if (GUI.reviewmode == ReviewMode.adjudicationMode)
                article = adjudication.data.AdjudicationDepot
                        .getArticleByFilename(currentTextSource.getName());
            else
            ...
            for (Annotation annotation : article.annotations) {
                ...
                if (annotation.hasAttribute())
                    ((userInterface.txtScreen.TextScreen) this.textPaneforClinicalNotes)
                            .addAttAnnotation(annotation);
                if (annotation.hasRelationship())
                    ((userInterface.txtScreen.TextScreen) this.textPaneforClinicalNotes)
                            .addRelAnnotation(annotation);
    ...
    private void display_relationshipPath_setPath(Annotation annotation) {
        ...
        try {
            ...
            source_color = resultEditor.annotationClasses.Depot.getColor(annotation.annotationclass
                    .trim());

            // pull out all relationships of the given annotation
            for (AnnotationRelationship complex : annotation.relationships) {
                for (AnnotationRelationshipDef end : complex
                    ...
                    if (reviewmode == ReviewMode.adjudicationMode) {
                        ...
                        linkedAnnotation = depotOfAdj.getAnnotationByUnique(WorkSet
                                .getCurrentFile().getName(), end.linkedAnnotationIndex);
                    } else
                        linkedAnnotation = depot.getAnnotationByUnique(WorkSet.getCurrentFile()
                                .getName(), end.linkedAnnotationIndex);
                    ...
                    linked_color = resultEditor.annotationClasses.Depot
                            .getColor(linkedAnnotation.annotationclass.trim());

                    // set the source annotation and the first linked annotation
                    if (count == 1) {

                        ((userInterface.txtScreen.TextScreen) this.textPaneforClinicalNotes)
                                .setComplexRelationsCoordinates(annotation.spanset, // spanset
                                        // of
                                        // the
                                        // given
                                        // annotation
                                        source_color, objectiveSpans, // spanset
                                        // of
                                        // the
                                        // linked
                                        // annotation
                        ...
                        ((userInterface.txtScreen.TextScreen) this.textPaneforClinicalNotes)
                                .setComplexRelationsCoordinates_extraEnds(objectiveSpans, // spanset
                                        // of
                                        // the
                                        // linked
                                        // annotation
            ...
            Graphics g1 = ((userInterface.txtScreen.TextScreen) this.textPaneforClinicalNotes)
                    .getGraphics();
            ...
            log.LoggingToFile
                    .log(Level.SEVERE,
                            "error 1010132130:: fail to set graph path for complex relationship of current annotation!!!");
        }
    ...
    private Annotation getlinkedAdjudicatedAnnotation(Annotation annotation) {
        ...
        try {
            ...
            if ((annotation.adjudicationAlias != null)
                    && (!SugarSeeder.isAdjudicationAlias(annotation.adjudicationAlias))) {
            ...
            // Annotation ann = depot.getAnnotationByUnique(filename,
            // uniqueindex);
    ...
    /**
     * Search designated text content from current text in the text area of
     * result editor. And highlight results(found terms) with two black bar on
     * them. Give a beep as warnning if nothing got found.
     */
    private void searchWord() {
        resultEditor.wordSearcher.Searcher wordsearcher = new resultEditor.wordSearcher.Searcher(
                textPaneforClinicalNotes, this);
    ...
    private void setWorkSpace() {
        setWorkSpace(env.Parameters.WorkSpace.WorkSpace_AbsolutelyPath);
    }

    /**
     * check and set workspace setting
     */
    private void setWorkSpace(String workspace_path) {
     ...
     * after the selected annotation.
     *
     * @param next - true if you're looking for the next annotation, false if
     *             you're looking for the previous annotation
     */
    private boolean moveToNextAnnotation(boolean next) {
        WorkSet.latestScrollBarValue = jScrollPane_textpane
                .getVerticalScrollBar().getValue();
        ...
        Depot depot = new Depot();
        Article article = depot.getArticleByFilename(WorkSet.getCurrentFile().getName());
        if (article.annotations.size() == 0) {
            return false;
        }
        Annotation currentNext = null;
        // Get the current annotation so we can use it to find the next
        // annotation
        Annotation current = WorkSet.currentAnnotation;

        if (current == null) {
            currentNext = article.annotations.get(0);
        } else {

            // This will store the current minimum distance between two
            // annotations
            ...
            for (Annotation possibleNext : article.annotations) {
                ...
                // If the this annotation is closer to the selected annotation
                // then any found so far, and it is not before
                // then set this annotation to be the closes annotation
                if (next && ((span.start - current.spanset.getSpanAt(0).start) < min)
                        && ((span.start - current.spanset.getSpanAt(0).start) > 0)) {
                    min = span.start - current.spanset.getSpanAt(0).start;
                    currentNext = possibleNext;
                }
                // If we're looking for the previous annotation then just do the
                // opposite comparison..
                if (!next && ((current.spanset.getSpanAt(0).start - span.start) < min)
        ...
        // If we found an annotation after the selected one, then display info
        // for it
        // and jump to it.
        if (currentNext != null) {
     ...
     * use a class using the annotation information format. ***Does not support
     * classes with spaces*****
     *
    ...
    // while clicking button to enter gui of interactive editor, do fellowing
    // things:
    ...
    private void setScreen_toInteractive() {
        ...
        if (size < 1) {
            log.LoggingToFile.log(Level.SEVERE,
                    "~~~~ INFO ~~~~: No document can be list in the combolist on document viewer:");
            return;
        }
        ...
        try {
            // show inputted file into the combobox
            for (int i = 0; i < size; i++) {
                jComboBox_InputFileList
                        .addItem(env.Parameters.corpus.LIST_ClinicalNotes.get(i).file.getName());
            }
        } catch (Exception ex) {
            log.LoggingToFile.log(Level.SEVERE,
    ...
    public void showFileContextInTextPane(int index) {
        ...
        try {
            ...
            resultEditor.display.Screen display = new resultEditor.display.Screen(
                    textPaneforClinicalNotes, currentTextSource // text source
            );
    ...
    public void showFileContextInTextPane(File _current_text_file) {
        ...
        // ##4 SHOW text content on screen and HIGHLIGHT annotations
        resultEditor.display.Screen display = new resultEditor.display.Screen(
                textPaneforClinicalNotes, _current_text_file // text source
        );
        display.ShowTextAndBackgroundHighLight(contents);
    }
    ...
    /**
     * if the indicator is "ON"(false), check and correct span border by space
     * or symbols, o.w. use exact span user just selected
     *
    ...
    private void restoreDeleted() {
        if (WorkSet.getLastDeleted() != null
                && WorkSet.getCurrentFile().getName().equals(WorkSet.getLastDeletedFilename())) {
            Depot depot = new Depot();
     ...
     * eHOST. This method checks whether any children component is in the tab.
     * And if the tab didn't get any children component yet, it will add the
     * report panel into the tab as set then maximum the components.
     * <p>
        ...
        if (comp_count == 0) {
            ...
            try {
                ...
                log.LoggingToFile.log(Level.SEVERE, "~~~~ ERROR ~~~~::1108091211:: error occurred"
                        + " while eHOST try to load and show the report panel" + " on screen!!!"
                        + "\n" + ex.getMessage());
            }
        }
    ...
    // <editor-fold defaultstate="collapsed"
    // desc="Private Methods - Relationships(Simple and Complex)">
    ...
    private void addRelationship(int position) {
        try {
            ...
            // ---- step 0.0 ----
            // temporary list used to record the annotations in the start point
            // of
            // the relationship and the annotations in the dest point of this
            // possible
            // relationship.
            ...
            if (env.Parameters.CreateRelationship.where == 2) {
                annotation_left = ((userInterface.annotationCompare.ExpandButton) jPanel60)
                        .getSelectedAnnotation();
            }

            if ((annotation_left == null) || (annotation_left.annotationclass == null)
            ...
            // ---- step 1.2 ----
            // get all selected annotations (not by current clicking, they
            // selected by previous clicking)
            Depot depotOfAnn = new Depot();
            Vector<Integer> selectedIndexes = Depot.SelectedAnnotationSet
                    .getSelectedAnnotationSet();

            // ---- step 1.3 ----
            // record annotations on the source point of the possible
            // relationship
            if (env.Parameters.CreateRelationship.where == 2) {
                ...
                if ((selectedIndexes == null) || (selectedIndexes.size() < 1)) {
                    ...
                    for (int i = 0; i < selectedIndexes.size(); i++) {
                        ...
                        if (GUI.reviewmode == ReviewMode.adjudicationMode) {
                            adjudication.data.AdjudicationDepot depotOfAdj = new adjudication.data.AdjudicationDepot();
                            a = depotOfAdj.getAnnotationByUnique(
                                    WorkSet.getCurrentFile().getName(), selectedIndexes.get(i));
                        } else
                            a = depotOfAnn.getAnnotationByUnique(
                                    WorkSet.getCurrentFile().getName(), selectedIndexes.get(i));

                        if (a != null) {
                            sourceAnnotations.add(a);
                            // System.out.println("[REL BUILDER] Source Annotation : "
                            // + a.annotationText );
                        }
                    }
                    // }
            ...
            Vector<Integer> indices = depotOfAnn.getSelectedAnnotationIndexes(WorkSet
                            .getCurrentFile().getName(), // filename of current document
            ...
            // If something was clicked on then just use the first one on the
            // list...
            // TODO: Might want to expand on this later to allow user to
            // disambiguate multiple
            // selections
            Annotation destAnnotation = null;
            if (GUI.reviewmode == ReviewMode.adjudicationMode) {
                adjudication.data.AdjudicationDepot depotOfAdj = new adjudication.data.AdjudicationDepot();
                destAnnotation = depotOfAdj.getAnnotation(WorkSet.getCurrentFile().getName(),
                        indices.get(0));
            } else
                destAnnotation = depotOfAnn.getAnnotation(WorkSet.getCurrentFile().getName(),
                        indices.get(0));
            if ((destAnnotation == null) || (destAnnotation.annotationclass == null)
            ...
            for (int i = 0; i < indices.size(); i++) {
                ...
                if (GUI.reviewmode == ReviewMode.adjudicationMode) {
                    adjudication.data.AdjudicationDepot depotOfAdj = new adjudication.data.AdjudicationDepot();
                    a = depotOfAdj
                            .getAnnotation(WorkSet.getCurrentFile().getName(), indices.get(i));
                } else {
                    a = depotOfAnn
                            .getAnnotation(WorkSet.getCurrentFile().getName(), indices.get(i));
                }
                if (a != null) {
                    ...
                    // if( a.adjudicationStatus ==
                    // Annotation.AdjudicationStatus.MATCHES_DLETED )
                    // continue;
                    // }
             ...
             * if (GUI.reviewmode == GUI.ReviewMode.adjudicationMode) {
             *
             * if (sourceAnnotations != null) { for (int i = 0; i <
             * sourceAnnotations.size(); i++) { Annotation annotation =
             * sourceAnnotations.get(i); //if (annotation.adjudicationStatus !=
             * Annotation.AdjudicationStatus.MATCHES_OK) //||(
             * annotation.adjudicationStatus ==
             * AdjudicationStatus.NONMATCHES_DLETED )) //{
             * sourceAnnotations.set(i, null); //} }
             *
             * for (int i = 0; i < objectAnnotations.size(); i++) { Annotation
             * annotation = objectAnnotations.get(i); //if
             * (annotation.adjudicationStatus !=
             * Annotation.AdjudicationStatus.MATCHES_OK) // ||(
             * annotation.adjudicationStatus ==
             * AdjudicationStatus.NONMATCHES_DLETED )) //{
            ...
            // check if we need to popup a dialog to handle complex status to
            // create
            // relationships
            ...
            if (relCheckResult.only_one_possible_relationship) {
                ...
                resultEditor.relationship.complex.RelationshipBuilder rbuilder = new resultEditor.relationship.complex.RelationshipBuilder(
                        this, relCheckResult, WorkSet.getCurrentFile().getName());
            ...
            // if (GUI.reviewmode == GUI.ReviewMode.adjudicationMode) {
            // if ((annotation_left.adjudicationStatus !=
            // Annotation.AdjudicationStatus.MATCHES_OK)
            // || (destAnnotation.adjudicationStatus !=
            // Annotation.AdjudicationStatus.MATCHES_OK)) {
            // commons.Tools.beep();
            // return;
            // }
            ...
            boolean health_of_rel = env.Parameters.RelationshipSchemas.checkRegexExists(sourceClass
                    + destClass);
            ...
            if (annotation_left.relationships == null) {
                ...
                // so what we need to do is check whether the one that we want
                // to add is
                // existing or not. And if not, we add it.
                // If the Relationship already existed try to remove the
                // Annotation
                /*
            ...
            relationship.complex.dataTypes.RelationshipDef relationshipSchema = env.Parameters.RelationshipSchemas
                    .getRelationshipSchema(rulename);
            if (relationshipSchema != null) {
                relationship.simple.dataTypes.AttributeList attributeDefs = relationshipSchema
                        .getAttributes();
                if (attributeDefs != null) {
                    for (AttributeSchemaDef attdef : attributeDefs.getAttributes()) {
                        ...
                        if (attdef.hasDefaultValue()) {
                            ...
                            newRelationship.attributes.add(new AnnotationAttributeDef(attdef
                                    .getName(), attdef.getDefault()));
                        }
                    }
                }
            }
            ...
            {
                // See if the selected annotations have markable classes inside
                // of the
                 ...
                 * String name =
                 * env.Parameters.ComplexRelationshipNames.getNameByRegex
                 * (classes);
                 */
                // If name is non-null then name the relationship, else clear
                // out the name.
                // if (rulename != null) {
     ...
     * relationships. Before really creating a relationship, user usually need
     * to click two times on the document viewer to select annotations. Two of
     * these annotations will be selected as the start point and end point as a
     * pair annotations, so we can set up relationship between. We may get
     * serveral annotation pairs and corresponsed relationships. This is
     * considered as a complex situation as we don't which one is user really
     * want.
     *
     * @param sourceAnnotations in format of "Vector<Annotation>"; they are all source
     *                          annotations.
     * @param objectAnnotations in format of "Vector<Annotation>"; they are all objective
     *                          annotations.
     * @return true, if eHOST think it need to popup a dialog to deal with this
     * complex situation. false, if no needed to popup a dialog.
     */
    private RelCheckResult checkRelStatus(ArrayList<Annotation> sourceAnnotations,
                                          ArrayList<Annotation> objectAnnotations) {
        ...
        // ---- 2.1 ----
        // set annotation to null if it can't build a relationship with any
        // annotation in
        ...
        for (int i = 0; i < sourceAnnotations.size(); i++) {
            ...
            boolean flag = false; // flag: indicates whether annotation "a" have
            // chance to build
        ...
        } // To multiple annotations, we need to remove annotations that there
    ...
    public boolean stopRelationshiping() {
        if ((addingTo != null) && (WorkSet.currentAnnotation != null)) {
            // See if the selected annotations have markable classes inside of
            // the
            // current relationship schema
            ArrayList<String> classes = new ArrayList<String>();
     ...
     */
    public void display_editor_ListRelationships(
    ...
    /*
     * private void openRelationshipViewer() { Vector<iListable> listable = new
     * Vector<iListable>(); if(WorkSet.currentAnnotation == null) return;
     * if(WorkSet.currentAnnotation.ComplexRelationships!= null) {
     * for(ComplexRelationship f:
     * WorkSet.currentAnnotation.ComplexRelationships) { listable.add(f); } }
     * if(editor == null || !editor.isVisible()) { editor = new
     * resultEditor.relationship.Editor(this, listable,
     * resultEditor.relationship.Editor.Type.ComplexRelationships);
    ...
    private void openAttributeEditor() {
        ...
        if (editor == null || !editor.isVisible()) {
            editor = new resultEditor.relationship.Editor(this, WorkSet.currentAnnotation,
    ...
    private void openRelAttributeEditor() {
        ...
        if (editor_attributeOnRelationship == null || !editor_attributeOnRelationship.isVisible()) {
            editor_attributeOnRelationship = new resultEditor.relationship.attributes.Editor(
                    WorkSet.currentAnnotation, relationship, this, this);
    ...
    /**
     * get the selected relationship from the list if relationship on the editor
     * panel.
     */
     ...
     * flagged by the Verifier using the current verifier dictionaries and
     * settings.
     */
    private void callVerifierWithCurrent() {
        ...
        verifier.SpanCheck spanCheck = new verifier.SpanCheck(
                env.Parameters.corpus.getAbsoluteFileName(jComboBox_InputFileList
                        .getSelectedIndex()), env.Parameters.VERIFIER_DICTIONARIES, writer);
        ...
        for (Article art : depot.getAllArticles()) {
            ...
            if (art.baseArticle == null) {
                verifier.MatchOldAndNew.MatchArticleWithDirectory(art,
                        env.Parameters.verifierComparisonSettings.getDirectoryString());
            }
            if (art.baseArticle != null) {
    ...
    private void callVerifierWithAll() {
            ...
            if (art.baseArticle != null) {
                ...
                for (File f : possibleMatches) {
                    if (f.getName().equals(art.filename)) {
                        ...
                        FLAG_MAYBE_CHANGED = false;
                        verifier.SpanCheck spanCheck = new verifier.SpanCheck(f.getAbsolutePath(),
                                env.Parameters.VERIFIER_DICTIONARIES, writer);
                        spanCheck.findProblems(-1);
                    }
        ...
        for (File file : WorkSet.getAllTextFile()) {
            /*
             * FLAG_MAYBE_CHANGED = false; verifier.SpanCheck spanCheck = new
             * verifier.SpanCheck( file.getAbsolutePath(),
             * env.Parameters.VERIFIER_DICTIONARIES, writer);
             * spanCheck.findProblems(-1);
             */
        }
    ...
    // <editor-fold defaultstate="collapsed"
    // desc="Private Methods - Preannotate Tab">
     ...
     * the annotations information tab, this will display the Annotations with
     * annotators matching the chosen annotator.
     */
    ...
    private JFileChooser setFileChooserAttributes(fileInputType type) {
        ...
        if (type == fileInputType.importXMLandPin) {
            ...
            javax.swing.filechooser.FileFilter[] filefilters = jFileChooser2
            ...
            javax.swing.filechooser.FileFilter[] filefilters = jFileChooser1
                    .getChoosableFileFilters();
    ...
    private void setToClasses() {
        ...
        for (Annotation annotation : annotationsList) {
            ...
            for (int i = 0; i < theClasses.size(); i++) {
                // If it matches this class then increment the coresponding
                // count
        ...
        for (int i = 0; i < theClasses.size(); i++) {
            theClasses.set(i, "<html>Class Name: " + theClasses.get(i)
                    + " <br><font color = \"gray\">Count in File: " + counts.get(i)
                    + "</font></html>");
        }
    ...
    // <editor-fold defaultstate="collapsed"
    // desc="Private Methods - Importing Annotations">

    /**
     * Import annotations from XML or PIN files and show on screen.
     * <p>
     * #1 show file chooser to let users select XML or PINS files.
     * <p>
     * #2 (subfunction)extract annotation from pin or xml files.
     * <p>
    ...
    public void importAnnotations() {
        ...
        try {
            ...
            // to all selected files to import, let's get knowtator xml files
            // whose filenames are
            // appeared in the list of text sources after string
            // ".knowtator.xml" removed
            ...
            for (int i = 0; i < loops; i++) {
                ...
                for (int j = 0; j < size_InputedClinicalNotes; j++) {
                    ...
                    env.clinicalNoteList.CorpusStructure corpus = env.Parameters.corpus.LIST_ClinicalNotes
                            .get(j);
                    if (corpus == null)
                        continue;
                    if (corpus.file == null)
        ...
        // TreeSet<AttributeSchemaDef> newAttributes = new
        // TreeSet<AttributeSchemaDef>();
        ...
        // env.Parameters.AttributeSchemas.checkExists(newOnes) );
        ...
        if ((env.Parameters.AnnotationImportSetting.needSchemaHandler)
            ...
            relationship.importing.WrapperForBoth wrapper = new relationship.importing.WrapperForBoth(
                    unknownAttributes, unknowRelationships, this, loops + " file(s) selected: "
                    + (matchedAnnotationFiles.size() + count)
                    + " file(s) imported for matching text files.");
            wrapper.doImportForBoth();
        }
        // If no unknown attributes/relatinships just show a message indicating
        // how many files inputted.
        else {
     ...
     *
     * @param files the designated PINS files.
    ...
    private void extractAnnotation_fromXML(Vector XMLFiles) {
        ...
        try {
            ...
            for (File f : (Vector<File>) XMLFiles) {
                ...
                if (f instanceof File) {
                    ...
                    // System.out.println("xml annotation file name and path saved! -"
                    // + f.toString() );
                }
            }
        ...
        ImportAnnotation imports = new ImportAnnotation();
    ...
    // <editor-fold defaultstate="collapsed"
    // desc="Private Methods - Tab Management">

    /**
     * Enter different tab by user's selection
     *
     * @param _tab show which tab user is expecting for
     *             <p>
     *             type is enum <code>tabs</code>{
     *             <p>
     *             creationAnnotation, resulteditor, dictionariesSetting,
     *             <p>
     *             pinExtractor, dictionariesManager, exit
     *             <p>
     *             };
     *             <p>
     */
    public void tabDoorman(TabGuard.tabs _tab) {
        ...
        if ((_tab != TabGuard.tabs.creationAnnotation) && (tab != TabGuard.tabs.resulteditor))
            hideStatusButtons();
        ...
        // set right button selected
        if ((_tab == TabGuard.tabs.exit) || (_tab == TabGuard.tabs.dictionariesSetting)) {
    ...
    private void setTabButton(TabGuard.tabs _tab) {
        ...
        Color C = new Color(41, 41, 41);

        // set font of buttons on tools bar
        jToggleButton_CreateAnnotaion.setForeground(_tab == TabGuard.tabs.creationAnnotation ? C
                : c);
        jToggleButton_CreateAnnotaion.setFont(_tab == TabGuard.tabs.creationAnnotation ? F : f);

        jToggleButton_ResultEditor.setForeground(_tab == TabGuard.tabs.resulteditor ? C : c);
        jToggleButton_ResultEditor.setFont(_tab == TabGuard.tabs.resulteditor ? F : f);

        jToggleButton_PinExtractor.setForeground(_tab == TabGuard.tabs.pinExtractor ? C : c);
        jToggleButton_PinExtractor.setFont(_tab == TabGuard.tabs.pinExtractor ? F : f);

        jToggleButton_Converter.setForeground(_tab == TabGuard.tabs.converter ? C : c);
        jToggleButton_Converter.setFont(_tab == TabGuard.tabs.converter ? F : f);

        jToggleButton_DictionaryManager.setForeground(_tab == TabGuard.tabs.dictionariesManager ? C
                : c);
        jToggleButton_DictionaryManager.setFont(_tab == TabGuard.tabs.dictionariesManager ? F : f);

        jToggleButton_DictionarySetting.setForeground(_tab == TabGuard.tabs.dictionariesSetting ? C
                : c);
        jToggleButton_DictionarySetting.setFont(_tab == TabGuard.tabs.dictionariesSetting ? F : f);

        jToggleButton_exit.setFont(_tab == TabGuard.tabs.exit ? F : f);

    }

    /**
     * reenabled these button we just used before open a new dialog and current
     * frame lost focus.
     */
    ...
    /**
     * It a methed that only can be called by the class of "AssignmentsScreen"
     * to carry out a sync operation between eHOST and annotation admin server.
     */
    ...
    /**
     * Set the menu bar and buttons visible by given flag. On the Editor panel,
     * there are two buttons only for ""
     */
    ...
    public void diffjumper(int start, int end) {
        ...
        try {
            ...
            // if(( this.textPaneforClinicalNotes.getDocument() != null )
            // && ( cursorPosition + 40 <
            // this.textPaneforClinicalNotes.getDocument().getLength() ) )
            ...
            // annotations
            ArrayList<Annotation> selectedAnnotaions = Depot.SelectedAnnotationSet
                    .selectAnnotations_ByPosition(textsourceFilename, start + 1, false);
            ...
            // Record for current workset: latest position in text panel
            WorkSet.latestClickPosition = start + 1;
            ...
            if (amount > 0) {
                // record mouse position
                WorkSet.latestValidClickPosition = start + 1;
    ...
    /**
     * refresh part of screen after adding a new annotation in adjudication
     * mode, it should be call by the class of "popmenu.java" after adding
     * annotation
     */
    ...
    /**
     * event: mouse clicked on class tree view. Only can called by system
     * listener.
     */
    private void userMouseClicked_onClassTreeView(MouseEvent evt) {
        resultEditor.annotationClasses.mouse.ClickedListener clicklistener = new resultEditor.annotationClasses.mouse.ClickedListener(
                evt, jTree_class, this, textPaneforClinicalNotes);
    ...
    public void display_refreshNAV_WorkSpace() {
        ...
        if (workspacepath == null) {
            ...
            workSpace.switcher.RecentWorkSpace rw = new workSpace.switcher.RecentWorkSpace(
                    jComboBox_currentworkspace_abspath);
            rw.emptyCombobox();
    ...
    /**
     * The method is gonna to update your GUI component and some values by the
     * parameters that you got from projectschema.cfg of current project.
     * <p>
     * It update several status buttons on screen by these project parameters.
     * There are several status buttons on the status bar at the button of eHOST
     * window, such as Oracle status button, Diff status button, etc.
     */
    ...
    public enum ReviewMode {
        ANNOTATION_MODE, adjudicationMode, OTHERS // eHOST maybe in other
        // function model
    }
