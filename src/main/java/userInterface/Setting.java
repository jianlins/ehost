 ...
 * @author Leng
 */
public class Setting extends JFrame implements PropertyChangeListener
{
     ...
     */
    public Setting(int _parentX, int _parentY, int _parentWidth, int _parentHeight, GUI _gui) {
        ...
        */
        ...
        else  jRadioButton_sameWeight.setSelected(true);
    ...
    private void initComponents() {
        ...
        jButton_down2 = new javax.swing.JButton();
        ...
        jPanel_title_dictionaries_list.setPreferredSize(new Dimension(233, 26));
        ...
        jPanel8.setMaximumSize(new Dimension(32767, 5));
        jPanel8.setMinimumSize(new Dimension(100, 5));
        jPanel8.setPreferredSize(new Dimension(100, 5));
        ...
        jButton_down2.setBackground(new java.awt.Color(226, 226, 226));
        jButton_down2.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        jButton_down2.setText("INIT");
        jButton_down2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_down2ActionPerformed(evt);
            }
        });
        jPanel19.add(jButton_down2);
        ...
        jPanel_title_dictionaries_list1.setMaximumSize(new Dimension(2147483647, 237));
        jPanel_title_dictionaries_list1.setMinimumSize(new Dimension(225, 23));
        jPanel_title_dictionaries_list1.setPreferredSize(new Dimension(317, 23));
        ...
        jPanel17.setMaximumSize(new Dimension(2147483647, 23));
        jPanel17.setMinimumSize(new Dimension(189, 23));
        jPanel17.setPreferredSize(new Dimension(574, 23));
        ...
        jLabel4.setMaximumSize(new Dimension(185, 23));
        jLabel4.setMinimumSize(new Dimension(185, 23));
        jLabel4.setPreferredSize(new Dimension(185, 23));
        ...
        jLabel5.setPreferredSize(new Dimension(200, 18));
        ...
        jPanel_title_dictionaries_list3.setPreferredSize(new Dimension(233, 26));
        ...
        jPanel11.setMaximumSize(new Dimension(32767, 5));
        jPanel11.setMinimumSize(new Dimension(100, 5));
        ...
        jPanel_title_dictionaries_list4.setPreferredSize(new Dimension(233, 26));
        ...
        jPanel18.setMaximumSize(new Dimension(32767, 5));
        jPanel18.setMinimumSize(new Dimension(100, 5));
        ...
        jPanel39.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel41.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel42.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel29.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel30.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel31.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel35.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel32.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel33.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel34.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel36.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel43.setPreferredSize(new Dimension(850, 20));
        ...
        jPanel44.setPreferredSize(new Dimension(850, 20));
    ...
    private void jButton_removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_removeActionPerformed
        /** remove selected dictionary from memory and list, then update the screen */
    ...
    private void jList_preAnnotated_concept_dictionaries1KeyPressed(KeyEvent evt)//GEN-FIRST:event_jList_preAnnotated_concept_dictionaries1KeyPressed
    ...
    private void jList_preAnnotated_concept_dictionaries1KeyReleased(KeyEvent evt)//GEN-FIRST:event_jList_preAnnotated_concept_dictionaries1KeyReleased
    ...
    private void jButton_down2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_down2ActionPerformed
        nlp.quickNLP.InitDlg initdlg = new nlp.quickNLP.InitDlg(this);
        initdlg.setVisible(true);
    }//GEN-LAST:event_jButton_down2ActionPerformed
    ...
    private static javax.swing.JButton jButton_down2;
