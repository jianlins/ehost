...
public class WizardConceptLib extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel_choosefile = new JPanel_dnd(this);
        ...
        setMinimumSize(new Dimension(618, 347));
        setResizable(false);
        setSize(new Dimension(618, 380));
        ...
        jPanel_CardLayout.setMaximumSize(new Dimension(558, 305));
        ...
        jPanel_Introduction.setMaximumSize(new Dimension(558, 305));
        ...
        jPanel_choosefile.setMaximumSize(new Dimension(558, 305));
        jPanel_choosefile.setPreferredSize(new Dimension(558, 305));
        ...
        jPanel_verifyer.setMaximumSize(new Dimension(558, 305));
        jPanel_verifyer.setPreferredSize(new Dimension(558, 305));
