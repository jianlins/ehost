...
public class Comparator extends javax.swing.JPanel {
    ...
    public Annotation getSelectedAnnotation(){
        ...
        try{
            ...
            if( selectedAnnotationObj != null){
                entry = (iListEntry) selectedAnnotationObj;
            }
        }catch(Exception ex){
            entry = null;
        }
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 0, 102)));
        ...
        jPanel43.setBackground(new Color(236, 233, 216));
        jPanel43.setPreferredSize(new java.awt.Dimension(390, 180));
        jPanel43.setLayout(new java.awt.BorderLayout());

        jPanel_colorfulTextBar_filebrowser5.setBackground(new Color(41, 119, 167));
        jPanel_colorfulTextBar_filebrowser5.setLayout(new java.awt.BorderLayout());

        jLabel28.setBackground(new Color(41, 119, 167));
        ...
        jPanel47.setBackground(new Color(237, 237, 237));
        jPanel47.setMaximumSize(new java.awt.Dimension(32767, 280));
        jPanel47.setMinimumSize(new java.awt.Dimension(1, 1));
        jPanel47.setLayout(new java.awt.BorderLayout());

        jPanel_multipleResultShowList1.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(240, 240, 240), 3));
        ...
        jPanel49.setBackground(new Color(237, 237, 237));

        jLabel13.setBackground(new Color(236, 233, 216));
        ...
        jPanel51.setBackground(new Color(237, 237, 237));
        ...
        jPanel_annotation_details1.setBackground(new Color(240, 240, 240));
        jPanel_annotation_details1.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(240, 240, 240), 2));
        ...
        jLabel19.setBorder(javax.swing.BorderFactory.createMatteBorder(4, 1, 1, 1, new Color(238, 238, 240)));
        ...
        jScrollPane_Spans.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(153, 153, 153)));
        ...
        jPanel56.setBackground(new Color(237, 237, 237));
        ...
        jPanel52.setBackground(new Color(237, 237, 237));
        jPanel52.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(240, 240, 240), 2));
        ...
        jLabel18.setBackground(new Color(236, 233, 216));
        ...
        jPanel53.setBackground(new Color(237, 237, 237));
        ...
        jTextField_annotationClassnames.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(153, 153, 153)));
        ...
        jLabel42.setBackground(new Color(236, 233, 216));
        ...
        jPanel78.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(240, 240, 240), 2));
        ...
        jTextArea_comment1.setBackground(new Color(240, 240, 240));
        ...
        jTextArea_comment1.setDisabledTextColor(new Color(0, 1, 0));
        ...
        jLabel39.setBackground(new Color(237, 237, 237));
        ...
        jPanel22.setBackground(new Color(238, 238, 239));
        ...
        jPanel71.setBackground(new Color(237, 237, 237));
        ...
        jLabel40.setBackground(new Color(237, 237, 237));
        ...
        jLabel37.setBackground(new Color(237, 237, 237));
...
//            String textsourcefilename = resultEditor.workSpace.WorkSet.getCurrentFile().getName();
    ...
    private void display_setRedRectangle_toMarkDifferences(){
        ...
        try{
            if (flags_of_differences.isDifference_inSpan){
                jPanel20.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(255, 0, 0), 2));
            }else{
        ...
        try{
            if (flags_of_differences.isDifference_inClass){
                jTextField_annotationClassnames.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(255, 0, 0), 2));
            }else{
        ...
        */
        ...
        try{
            if (flags_of_differences.isDifference_inAnnotator){
                jTextField_annotator.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(255, 0, 0), 2));
            }else{
        ...
        try{
            if (flags_of_differences.isDifference_inComplexRelationship){
                jPanel70.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(255, 0, 0), 2));
            }else{
        ...
        try{
            if (flags_of_differences.isDifference_inNormalRelationship){
                jPanel71.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(255, 0, 0), 2));
            }else{
    ...
    public void display_listAttributes( final Annotation annotation ) {
    ...
    private JList jList_attributes;
