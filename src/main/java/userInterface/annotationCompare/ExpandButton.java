...
//        }
    ...
    private void components_loadComparatorPane(){
        ...
        try{
            //panel_container.add(new UserInterface.AnnotationCompare.Comparator() );
            compartor = new Comparator(gui, this, textPaneforClinicalNotes);
    ...
    private void setRightPaneVisible(Boolean isVisible )
    {
        ...
        if( isVisible )
        {
            this.jpanel_motherPanel.setLayout(new GridLayout(1, 2, 4, 0));
        ...
        {
            this.jpanel_motherPanel.setLayout(new GridLayout(1, 1, 0, 0));
